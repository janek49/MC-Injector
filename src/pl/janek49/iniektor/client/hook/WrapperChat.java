...
public class WrapperChat implements IWrapper {
    ...
    @ResolveConstructor(version = {Version.MC1_9_4,Version.MC1_10}, name = "net/minecraft/util/text/TextComponentString", params = {"java/lang/String"})
    ...
    @ResolveMethod(version = {Version.MC1_9_4, Version.MC1_10}, name = "net/minecraft/client/entity/EntityPlayerSP/addChatMessage", descriptor = "(Lnet/minecraft/util/text/ITextComponent;)V")
