...
public class RealmsUploadScreen extends RealmsScreen {
   ...
   public void render(int var1, int var2, float var3) {
      ...
      if(this.errorMessage != null) {
         String[] vars4 = this.errorMessage.split("\\\\n");

         for(int var5 = 0; var5 < vars4.length; ++var5) {
            this.drawCenteredString(vars4[var5], this.width() / 2, 110 + 12 * var5, 16711680);
         }
      }
   ...
   private void drawProgressBar() {
      ...
      this.progress = String.format(Locale.ROOT, "%.1f", new Object[]{Double.valueOf(var1)});
   ...
   private void drawUploadSpeed() {
      if(this.animTick % 20 == 0) {
         if(this.previousWrittenBytes != null) {
            long var1 = System.currentTimeMillis() - this.previousTimeSnapshot.longValue();
            if(var1 == 0L) {
               var1 = 1L;
            }

            this.bytesPersSecond = 1000L * (this.uploadStatus.bytesWritten.longValue() - this.previousWrittenBytes.longValue()) / var1;
   ...
   private void drawUploadSpeed0(long l) {
      if(l > 0L) {
         ...
         String var4 = "(" + humanReadableByteCount(l) + ")";
   ...
   public static String humanReadableByteCount(long l) {
      ...
      if(l < 1024L) {
         ...
         int var3 = (int)(Math.log((double)l) / Math.log(1024.0D));
         String var4 = "KMGTPE".charAt(var3 - 1) + "";
         return String.format(Locale.ROOT, "%.1f %sB/s", new Object[]{Double.valueOf((double)l / Math.pow(1024.0D, (double)var3)), var4});
      }
   }
   ...
   public static RealmsUploadScreen.Unit getLargestUnit(long l) {
      if(l < 1024L) {
         ...
         int var2 = (int)(Math.log((double)l) / Math.log(1024.0D));
   ...
   public static double convertToUnit(long var0, RealmsUploadScreen.Unit realmsUploadScreen$Unit) {
      return realmsUploadScreen$Unit.equals(RealmsUploadScreen.Unit.B)?(double)var0:(double)var0 / Math.pow(1024.0D, (double)realmsUploadScreen$Unit.ordinal());
   }

   public static String humanReadableSize(long var0, RealmsUploadScreen.Unit realmsUploadScreen$Unit) {
      return String.format("%." + (realmsUploadScreen$Unit.equals(RealmsUploadScreen.Unit.GB)?"1":"0") + "f %s", new Object[]{Double.valueOf(convertToUnit(var0, realmsUploadScreen$Unit)), realmsUploadScreen$Unit.name()});
   }
         ...
         public void run() {
            ...
            try {
               if(RealmsUploadScreen.uploadLock.tryLock(1L, TimeUnit.SECONDS)) {
                  ...
                  var1 = RealmsUploadScreen.this.tarGzipArchive(new File(var6, RealmsUploadScreen.this.selectedLevel.getLevelId()));
                  if(RealmsUploadScreen.this.cancelled) {
                     RealmsUploadScreen.this.uploadCancelled();
                     return;
                  }
                  ...
                  if(RealmsUploadScreen.this.verify(var1)) {
                     ...
                     FileUpload var7 = new FileUpload(var1, RealmsUploadScreen.this.worldId, RealmsUploadScreen.this.slotId, var5, Realms.getSessionId(), Realms.getName(), Realms.getMinecraftVersionString(), RealmsUploadScreen.this.uploadStatus);
                     var7.upload((uploadResult) -> {
                  ...
                  if(RealmsUploadScreen.humanReadableSize(var7, var9).equals(RealmsUploadScreen.humanReadableSize(5368709120L, var10)) && var9 != RealmsUploadScreen.Unit.B) {
                     ...
                     RealmsUploadScreen.this.errorMessage = RealmsScreen.getLocalizedString("mco.upload.size.failure.line1", new Object[]{RealmsUploadScreen.this.selectedLevel.getLevelName()}) + "\\n" + RealmsScreen.getLocalizedString("mco.upload.size.failure.line2", new Object[]{RealmsUploadScreen.humanReadableSize(var7, var11), RealmsUploadScreen.humanReadableSize(5368709120L, var11)});
                     return;
                  }

                  RealmsUploadScreen.this.errorMessage = RealmsScreen.getLocalizedString("mco.upload.size.failure.line1", new Object[]{RealmsUploadScreen.this.selectedLevel.getLevelName()}) + "\\n" + RealmsScreen.getLocalizedString("mco.upload.size.failure.line2", new Object[]{RealmsUploadScreen.humanReadableSize(var7, var9), RealmsUploadScreen.humanReadableSize(5368709120L, var10)});
                  return;
               }
   ...
   private File tarGzipArchive(File file) throws IOException {
      ...
      try {
         ...
         this.addFileToTarGz(var2, file.getAbsolutePath(), "world", true);
         var2.finish();
         var4 = var3;
      } finally {
         if(var2 != null) {
   ...
   private void addFileToTarGz(TarArchiveOutputStream tarArchiveOutputStream, String var2, String var3, boolean var4) throws IOException {
      if(!this.cancelled) {
         File var5 = new File(var2);
         String var6 = var4?var3:var3 + var5.getName();
         TarArchiveEntry var7 = new TarArchiveEntry(var5, var6);
         tarArchiveOutputStream.putArchiveEntry(var7);
         if(var5.isFile()) {
            IOUtils.copy(new FileInputStream(var5), tarArchiveOutputStream);
            tarArchiveOutputStream.closeArchiveEntry();
         } else {
            tarArchiveOutputStream.closeArchiveEntry();
            File[] vars8 = var5.listFiles();
            if(vars8 != null) {
               for(File var12 : vars8) {
                  this.addFileToTarGz(tarArchiveOutputStream, var12.getAbsolutePath(), var6 + "/", false);
               }
            }
         }
