...
public class RealmsResetNormalWorldScreen extends RealmsScreen {
   ...
   public RealmsResetNormalWorldScreen(RealmsResetWorldScreen lastScreen) {
      this.generateStructures = Boolean.valueOf(true);
      this.levelTypeIndex = Integer.valueOf(0);
   ...
   public RealmsResetNormalWorldScreen(RealmsResetWorldScreen realmsResetWorldScreen, String buttonTitle) {
   ...
   private String levelTypeTitle() {
      ...
      return string + " " + this.levelTypes[this.levelTypeIndex.intValue()];
   }
