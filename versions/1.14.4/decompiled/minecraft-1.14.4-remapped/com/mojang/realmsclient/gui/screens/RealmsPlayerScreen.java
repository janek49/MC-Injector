...
public class RealmsPlayerScreen extends RealmsScreen {
   ...
   private void op(int i) {
      ...
      String var3 = ((PlayerInfo)this.serverData.players.get(i)).getUuid();
   ...
   private void updateOps(Ops ops) {
      for(PlayerInfo var3 : this.serverData.players) {
         var3.setOperator(ops.ops.contains(var3.getName()));
      }

   }

   private void uninvite(int selectedInvitedIndex) {
      this.updateButtonStates();
      if(selectedInvitedIndex >= 0 && selectedInvitedIndex < this.serverData.players.size()) {
         PlayerInfo var2 = (PlayerInfo)this.serverData.players.get(selectedInvitedIndex);
   ...
   class InvitedObjectSelectionList extends RealmsObjectSelectionList {
      ...
      public void selectItem(int selected) {
         ...
         if(selected != -1) {
            Realms.narrateNow(RealmsScreen.getLocalizedString("narrator.select", new Object[]{((PlayerInfo)RealmsPlayerScreen.this.serverData.players.get(selected)).getName()}));
         }
   ...
   class InvitedObjectSelectionListEntry extends RealmListEntry {
      ...
      public InvitedObjectSelectionListEntry(PlayerInfo mPlayerInfo) {
      ...
      private void renderInvitedItem(PlayerInfo playerInfo, int var2, int var3, int var4, int var5) {
         int var6;
         ...
         RealmsPlayerScreen.this.drawString(playerInfo.getName(), RealmsPlayerScreen.this.column1_x + 3 + 12, var3 + 1, var6);
