...
public class RealmsDownloadLatestWorldScreen extends RealmsScreen {
   ...
   private long getContentLength(String string) {
      ...
      return var2.contentLength(string);
   }
   ...
   private void drawDownloadSpeed() {
      if(this.animTick % 20 == 0) {
         if(this.previousWrittenBytes != null) {
            ...
            this.bytesPersSecond = 1000L * (this.downloadStatus.bytesWritten.longValue() - this.previousWrittenBytes.longValue()) / var1;
   ...
   private void drawDownloadSpeed0(long l) {
      if(l > 0L) {
         ...
         String var4 = "(" + humanReadableSpeed(l) + ")";
   ...
   public static String humanReadableSize(long l) {
      ...
      if(l < 1024L) {
         ...
         int var3 = (int)(Math.log((double)l) / Math.log(1024.0D));
         String var4 = "KMGTPE".charAt(var3 - 1) + "";
         return String.format(Locale.ROOT, "%.0f %sB", new Object[]{Double.valueOf((double)l / Math.pow(1024.0D, (double)var3)), var4});
      }
   }
