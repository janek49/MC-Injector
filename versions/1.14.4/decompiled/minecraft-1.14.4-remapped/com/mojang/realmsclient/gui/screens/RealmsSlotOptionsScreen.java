...
public class RealmsSlotOptionsScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.buttonsAdd(this.pvpButton = new RealmsButton(4, this.column2_x, RealmsConstants.row(1), this.column_width, 20, this.pvpTitle()) {
         public void onPress() {
            RealmsSlotOptionsScreen.this.pvp = Boolean.valueOf(!RealmsSlotOptionsScreen.this.pvp.booleanValue());
      ...
      this.buttonsAdd(this.spawnAnimalsButton = new RealmsButton(5, this.column2_x, RealmsConstants.row(3), this.column_width, 20, this.spawnAnimalsTitle()) {
         public void onPress() {
            RealmsSlotOptionsScreen.this.spawnAnimals = Boolean.valueOf(!RealmsSlotOptionsScreen.this.spawnAnimals.booleanValue());
      ...
      this.buttonsAdd(this.spawnMonstersButton = new RealmsButton(6, this.column2_x, RealmsConstants.row(5), this.column_width, 20, this.spawnMonstersTitle()) {
         public void onPress() {
            RealmsSlotOptionsScreen.this.spawnMonsters = Boolean.valueOf(!RealmsSlotOptionsScreen.this.spawnMonsters.booleanValue());
            this.setMessage(RealmsSlotOptionsScreen.this.spawnMonstersTitle());
         }
      });
      this.buttonsAdd(this.spawnProtectionButton = new RealmsSlotOptionsScreen.SettingsSlider(8, this.column1_x, RealmsConstants.row(7), this.column_width, this.spawnProtection.intValue(), 0.0F, 16.0F));
      this.buttonsAdd(this.spawnNPCsButton = new RealmsButton(7, this.column2_x, RealmsConstants.row(7), this.column_width, 20, this.spawnNPCsTitle()) {
         public void onPress() {
            RealmsSlotOptionsScreen.this.spawnNPCs = Boolean.valueOf(!RealmsSlotOptionsScreen.this.spawnNPCs.booleanValue());
      ...
      this.buttonsAdd(this.forceGameModeButton = new RealmsButton(10, this.column1_x, RealmsConstants.row(9), this.column_width, 20, this.forceGameModeTitle()) {
         public void onPress() {
            RealmsSlotOptionsScreen.this.forceGameMode = Boolean.valueOf(!RealmsSlotOptionsScreen.this.forceGameMode.booleanValue());
      ...
      this.buttonsAdd(this.commandBlocksButton = new RealmsButton(9, this.column2_x, RealmsConstants.row(9), this.column_width, 20, this.commandBlocksTitle()) {
         public void onPress() {
            RealmsSlotOptionsScreen.this.commandBlocks = Boolean.valueOf(!RealmsSlotOptionsScreen.this.commandBlocks.booleanValue());
   ...
   private String pvpTitle() {
      return getLocalizedString("mco.configure.world.pvp") + ": " + getLocalizedString(this.pvp.booleanValue()?"mco.configure.world.on":"mco.configure.world.off");
   }

   private String spawnAnimalsTitle() {
      return getLocalizedString("mco.configure.world.spawnAnimals") + ": " + getLocalizedString(this.spawnAnimals.booleanValue()?"mco.configure.world.on":"mco.configure.world.off");
   }

   private String spawnMonstersTitle() {
      return this.difficultyIndex == 0?getLocalizedString("mco.configure.world.spawnMonsters") + ": " + getLocalizedString("mco.configure.world.off"):getLocalizedString("mco.configure.world.spawnMonsters") + ": " + getLocalizedString(this.spawnMonsters.booleanValue()?"mco.configure.world.on":"mco.configure.world.off");
   }

   private String spawnNPCsTitle() {
      return getLocalizedString("mco.configure.world.spawnNPCs") + ": " + getLocalizedString(this.spawnNPCs.booleanValue()?"mco.configure.world.on":"mco.configure.world.off");
   }

   private String commandBlocksTitle() {
      return getLocalizedString("mco.configure.world.commandBlocks") + ": " + getLocalizedString(this.commandBlocks.booleanValue()?"mco.configure.world.on":"mco.configure.world.off");
   }

   private String forceGameModeTitle() {
      return getLocalizedString("mco.configure.world.forceGameMode") + ": " + getLocalizedString(this.forceGameMode.booleanValue()?"mco.configure.world.on":"mco.configure.world.off");
   }
   ...
   private void saveSettings() {
      if(!this.worldType.equals(RealmsServer.WorldType.ADVENTUREMAP) && !this.worldType.equals(RealmsServer.WorldType.EXPERIENCE) && !this.worldType.equals(RealmsServer.WorldType.INSPIRATION)) {
         this.parent.saveSlotSettings(new RealmsWorldOptions(this.pvp, this.spawnAnimals, this.spawnMonsters, this.spawnNPCs, this.spawnProtection, this.commandBlocks, Integer.valueOf(this.difficultyIndex), Integer.valueOf(this.gameModeIndex), this.forceGameMode, this.getSlotName()));
      } else {
   ...
   class SettingsSlider extends RealmsSliderButton {
      ...
      public void applyValue() {
         if(RealmsSlotOptionsScreen.this.spawnProtectionButton.active()) {
            RealmsSlotOptionsScreen.this.spawnProtection = Integer.valueOf((int)this.toValue(this.getValue()));
         }
      }
