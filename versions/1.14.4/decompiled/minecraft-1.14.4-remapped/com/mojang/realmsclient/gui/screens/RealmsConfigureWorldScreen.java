...
public class RealmsConfigureWorldScreen extends RealmsScreenWithCallback implements RealmsWorldSlotButton.Listener {
   ...
   public void init() {
      ...
      this.buttonsAdd(this.optionsButton = new RealmsButton(5, this.leftButton(0), RealmsConstants.row(13) - 5, 90, 20, getLocalizedString("mco.configure.world.buttons.options")) {
         public void onPress() {
            Realms.setScreen(new RealmsSlotOptionsScreen(RealmsConfigureWorldScreen.this, ((RealmsWorldOptions)RealmsConfigureWorldScreen.this.serverData.slots.get(Integer.valueOf(RealmsConfigureWorldScreen.this.serverData.activeSlot))).clone(), RealmsConfigureWorldScreen.this.serverData.worldType, RealmsConfigureWorldScreen.this.serverData.activeSlot));
         }
      });
   ...
   private void fetchServerData(final long l) {
      (new Thread() {
         public void run() {
            ...
            try {
               RealmsConfigureWorldScreen.this.serverData = var1.getOwnWorld(l);
   ...
   public void onSlotClick(int var1, @Nonnull RealmsWorldSlotButton.Action realmsWorldSlotButton$Action, boolean var3, boolean var4) {
      switch(realmsWorldSlotButton$Action) {
      case NOTHING:
         break;
      case JOIN:
      ...
      case SWITCH_SLOT:
         ...
         break;
      default:
         throw new IllegalStateException("Unknown action " + realmsWorldSlotButton$Action);
      }
   ...
   private void switchToFullSlot(int var1, RealmsServer realmsServer) {
      ...
      Realms.setScreen(new RealmsLongConfirmationScreen((var3, var4) -> {
         if(var3) {
            this.switchSlot(realmsServer.id, var1);
         } else {
   ...
   private void switchToEmptySlot(int var1, RealmsServer realmsServer) {
      String var3 = getLocalizedString("mco.configure.world.slot.switch.question.line1");
      String var4 = getLocalizedString("mco.configure.world.slot.switch.question.line2");
      Realms.setScreen(new RealmsLongConfirmationScreen((var3, var4) -> {
         if(var3) {
            RealmsResetWorldScreen var5 = new RealmsResetWorldScreen(this, realmsServer, this.getNewScreen(), getLocalizedString("mco.configure.world.switch.slot"), getLocalizedString("mco.configure.world.switch.slot.subtitle"), 10526880, getLocalizedString("gui.cancel"));
            var5.setSlot(var1);
   ...
   public void saveSlotSettings(RealmsWorldOptions realmsWorldOptions) {
      RealmsWorldOptions realmsWorldOptions = (RealmsWorldOptions)this.serverData.slots.get(Integer.valueOf(this.serverData.activeSlot));
      realmsWorldOptions.templateId = realmsWorldOptions.templateId;
      realmsWorldOptions.templateImage = realmsWorldOptions.templateImage;
      RealmsClient var3 = RealmsClient.createRealmsClient();

      try {
         var3.updateSlot(this.serverData.id, this.serverData.activeSlot, realmsWorldOptions);
   ...
   public void openTheWorld(boolean var1, RealmsScreen realmsScreen) {
      RealmsTasks.OpenServerTask var3 = new RealmsTasks.OpenServerTask(this.serverData, this, this.lastScreen, var1);
      RealmsLongRunningMcoTaskScreen var4 = new RealmsLongRunningMcoTaskScreen(realmsScreen, var3);
      var4.start();
   ...
   public void closeTheWorld(RealmsScreen realmsScreen) {
      ...
      RealmsLongRunningMcoTaskScreen var3 = new RealmsLongRunningMcoTaskScreen(realmsScreen, var2);
      var3.start();
   ...
   private void switchSlot(long var1, int var3) {
      ...
      RealmsTasks.SwitchSlotTask var5 = new RealmsTasks.SwitchSlotTask(var1, var3, (var1, var2) -> {
         Realms.setScreen(var4);
      }, 11);
   ...
   private void switchMinigame(WorldTemplate worldTemplate) {
      RealmsTasks.SwitchMinigameTask var2 = new RealmsTasks.SwitchMinigameTask(this.serverData.id, worldTemplate, this.getNewScreen());
