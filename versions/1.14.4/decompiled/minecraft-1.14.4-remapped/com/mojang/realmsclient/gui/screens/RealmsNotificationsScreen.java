...
public class RealmsNotificationsScreen extends RealmsScreen {
   ...
   private static final List tasks = Arrays.asList(new RealmsDataFetcher.Task[]{RealmsDataFetcher.Task.PENDING_INVITE, RealmsDataFetcher.Task.TRIAL_AVAILABLE, RealmsDataFetcher.Task.UNREAD_NEWS});
