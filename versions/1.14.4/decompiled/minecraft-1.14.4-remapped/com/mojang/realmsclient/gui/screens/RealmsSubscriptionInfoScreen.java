...
public class RealmsSubscriptionInfoScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      Realms.narrateNow(new String[]{this.subscriptionTitle, this.subscriptionStartLabelText, this.startDate, this.timeLeftLabelText, this.daysLeftPresentation(this.daysLeft)});
   ...
   private void getSubscription(long l) {
      ...
      try {
         Subscription var4 = var3.subscriptionFor(l);
   ...
   private String localPresentation(long l) {
      Calendar var3 = new GregorianCalendar(TimeZone.getDefault());
      var3.setTimeInMillis(l);
