...
public class RealmsClient {
   ...
   public RealmsServer getOwnWorld(long l) throws RealmsServiceException, IOException {
      String var3 = this.url("worlds" + "/$ID".replace("$ID", String.valueOf(l)));
   ...
   public RealmsServerAddress join(long l) throws RealmsServiceException, IOException {
      String var3 = this.url("worlds" + "/v1/$ID/join/pc".replace("$ID", "" + l));
   ...
   public void uninvite(long var1, String string) throws RealmsServiceException {
      String string = this.url("invites" + "/$WORLD_ID/invite/$UUID".replace("$WORLD_ID", String.valueOf(var1)).replace("$UUID", string));
      this.execute(Request.delete(string));
   }

   public void uninviteMyselfFrom(long l) throws RealmsServiceException {
      String var3 = this.url("invites" + "/$WORLD_ID".replace("$WORLD_ID", String.valueOf(l)));
      this.execute(Request.delete(var3));
   }

   public RealmsServer invite(long var1, String string) throws RealmsServiceException, IOException {
   ...
   public BackupList backupsFor(long l) throws RealmsServiceException {
      String var3 = this.url("worlds" + "/$WORLD_ID/backups".replace("$WORLD_ID", String.valueOf(l)));
      String var4 = this.execute(Request.get(var3));
   ...
   public void updateSlot(long var1, int var3, RealmsWorldOptions realmsWorldOptions) throws RealmsServiceException, UnsupportedEncodingException {
      ...
      String var6 = realmsWorldOptions.toJson();
   ...
   public boolean switchSlot(long var1, int var3) throws RealmsServiceException {
      ...
      return Boolean.valueOf(var5).booleanValue();
   }

   public void restoreWorld(long var1, String string) throws RealmsServiceException {
      String string = this.url("worlds" + "/$WORLD_ID/backups".replace("$WORLD_ID", String.valueOf(var1)), "backupId=" + string);
      this.execute(Request.put(string, "", '鱀', 600000));
   }

   public WorldTemplatePaginatedList fetchWorldTemplates(int var1, int var2, RealmsServer.WorldType realmsServer$WorldType) throws RealmsServiceException {
      String var4 = this.url("worlds" + "/templates/$WORLD_TYPE".replace("$WORLD_TYPE", realmsServer$WorldType.toString()), String.format("page=%d&pageSize=%d", new Object[]{Integer.valueOf(var1), Integer.valueOf(var2)}));
      String var5 = this.execute(Request.get(var4));
      return WorldTemplatePaginatedList.parse(var5);
   }

   public Boolean putIntoMinigameMode(long var1, String string) throws RealmsServiceException {
      String string = "/minigames/$MINIGAME_ID/$WORLD_ID".replace("$MINIGAME_ID", string).replace("$WORLD_ID", String.valueOf(var1));
      String var5 = this.url("worlds" + string);
      return Boolean.valueOf(this.execute(Request.put(var5, "")));
   }

   public Ops op(long var1, String string) throws RealmsServiceException {
      String string = "/$WORLD_ID/$PROFILE_UUID".replace("$WORLD_ID", String.valueOf(var1)).replace("$PROFILE_UUID", string);
      String var5 = this.url("ops" + string);
      return Ops.parse(this.execute(Request.post(var5, "")));
   }

   public Ops deop(long var1, String string) throws RealmsServiceException {
      String string = "/$WORLD_ID/$PROFILE_UUID".replace("$WORLD_ID", String.valueOf(var1)).replace("$PROFILE_UUID", string);
      String var5 = this.url("ops" + string);
   ...
   public Boolean open(long l) throws RealmsServiceException, IOException {
      String var3 = this.url("worlds" + "/$WORLD_ID/open".replace("$WORLD_ID", String.valueOf(l)));
   ...
   public Boolean close(long l) throws RealmsServiceException, IOException {
      String var3 = this.url("worlds" + "/$WORLD_ID/close".replace("$WORLD_ID", String.valueOf(l)));
      String var4 = this.execute(Request.put(var3, ""));
      return Boolean.valueOf(var4);
   }

   public Boolean resetWorldWithSeed(long var1, String string, Integer integer, boolean var5) throws RealmsServiceException, IOException {
      RealmsWorldResetDto var6 = new RealmsWorldResetDto(string, -1L, integer.intValue(), var5);
   ...
   public Boolean resetWorldWithTemplate(long var1, String string) throws RealmsServiceException, IOException {
      RealmsWorldResetDto var4 = new RealmsWorldResetDto((String)null, Long.valueOf(string).longValue(), -1, false);
   ...
   public Subscription subscriptionFor(long l) throws RealmsServiceException, IOException {
      String var3 = this.url("subscriptions" + "/$WORLD_ID".replace("$WORLD_ID", String.valueOf(l)));
      String var4 = this.execute(Request.get(var3));
   ...
   public void acceptInvitation(String string) throws RealmsServiceException {
      String string = this.url("invites" + "/accept/$INVITATION_ID".replace("$INVITATION_ID", string));
   ...
   public UploadInfo upload(long var1, String string) throws RealmsServiceException {
      String string = this.url("worlds" + "/$WORLD_ID/backups/upload".replace("$WORLD_ID", String.valueOf(var1)));
      UploadInfo var5 = new UploadInfo();
      if(string != null) {
         var5.setToken(string);
      }
      ...
      return UploadInfo.parse(this.execute(Request.put(string, var8)));
   }

   public void rejectInvitation(String string) throws RealmsServiceException {
      String string = this.url("invites" + "/reject/$INVITATION_ID".replace("$INVITATION_ID", string));
      this.execute(Request.put(string, ""));
   }
   ...
   public void sendPingResults(PingResult pingResult) throws RealmsServiceException {
      ...
      this.execute(Request.post(var2, gson.toJson(pingResult)));
   }
   ...
   public void deleteWorld(long l) throws RealmsServiceException, IOException {
      String var3 = this.url("worlds" + "/$WORLD_ID".replace("$WORLD_ID", String.valueOf(l)));
      this.execute(Request.delete(var3));
   }

   private String url(String string) {
      return this.url(string, (String)null);
   }
   ...
   private String execute(Request request) throws RealmsServiceException {
      ...
      try {
         int var2 = request.responseCode();
         if(var2 == 503) {
            int var3 = request.getRetryAfterHeader();
            throw new RetryCallException(var3);
         } else {
            String var3 = request.text();
            if(var2 >= 200 && var2 < 300) {
               return var3;
            } else if(var2 == 401) {
               String var4 = request.getHeader("WWW-Authenticate");
               LOGGER.info("Could not authorize you against Realms server: " + var4);
               throw new RealmsServiceException(var2, var4, -1, var4);
