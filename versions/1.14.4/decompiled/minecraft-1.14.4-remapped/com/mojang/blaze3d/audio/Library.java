...
public class Library {
   ...
   @Nullable
   public Channel acquireChannel(Library.Pool library$Pool) {
      return (library$Pool == Library.Pool.STREAMING?this.streamingChannels:this.staticChannels).acquire();
   }
   ...
   public String getDebugString() {
      return String.format("Sounds: %d/%d + %d/%d", new Object[]{Integer.valueOf(this.staticChannels.getUsedCount()), Integer.valueOf(this.staticChannels.getMaxCount()), Integer.valueOf(this.streamingChannels.getUsedCount()), Integer.valueOf(this.streamingChannels.getMaxCount())});
   }
