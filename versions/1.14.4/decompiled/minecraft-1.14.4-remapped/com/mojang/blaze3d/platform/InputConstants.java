...
public class InputConstants {
   ...
   public static InputConstants.Key getKey(String string) {
      if(InputConstants.Key.NAME_MAP.containsKey(string)) {
         ...
         for(InputConstants.Type var4 : InputConstants.Type.values()) {
            if(string.startsWith(var4.defaultPrefix)) {
               String var5 = string.substring(var4.defaultPrefix.length() + 1);
   ...
   public static void setupKeyboardCallbacks(long var0, GLFWKeyCallbackI gLFWKeyCallbackI, GLFWCharModsCallbackI gLFWCharModsCallbackI) {
      GLFW.glfwSetKeyCallback(var0, gLFWKeyCallbackI);
      GLFW.glfwSetCharModsCallback(var0, gLFWCharModsCallbackI);
   }

   public static void setupMouseCallbacks(long var0, GLFWCursorPosCallbackI gLFWCursorPosCallbackI, GLFWMouseButtonCallbackI gLFWMouseButtonCallbackI, GLFWScrollCallbackI gLFWScrollCallbackI) {
      GLFW.glfwSetCursorPosCallback(var0, gLFWCursorPosCallbackI);
      GLFW.glfwSetMouseButtonCallback(var0, gLFWMouseButtonCallbackI);
      GLFW.glfwSetScrollCallback(var0, gLFWScrollCallbackI);
   }
   ...
   public static final class Key {
      ...
      public boolean equals(Object object) {
         if(this == object) {
            ...
            InputConstants.Key var2 = (InputConstants.Key)object;
   ...
   public static enum Type {
      ...
      private static void addKey(InputConstants.Type inputConstants$Type, String string, int var2) {
         InputConstants.Key var3 = new InputConstants.Key(string, inputConstants$Type, var2);
         inputConstants$Type.map.put(var2, var3);
      }

      private Type(String defaultPrefix) {
         this.defaultPrefix = defaultPrefix;
      }

      public InputConstants.Key getOrCreate(int i) {
         if(this.map.containsKey(i)) {
            return (InputConstants.Key)this.map.get(i);
         } else {
            String var2;
            if(this == MOUSE) {
               if(i <= 2) {
                  var2 = "." + MOUSE_BUTTON_NAMES[i];
               } else {
                  var2 = "." + (i + 1);
               }
            } else {
            ...
            InputConstants.Key var3 = new InputConstants.Key(this.defaultPrefix + var2, this, i);
            this.map.put(i, var3);
            return var3;
         }
      }
