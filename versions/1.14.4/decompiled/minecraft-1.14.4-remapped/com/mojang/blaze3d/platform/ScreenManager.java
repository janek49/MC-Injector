...
public class ScreenManager {
   ...
   public ScreenManager(MonitorCreator monitorCreator) {
      ...
      if(var2 != null) {
         for(int var3 = 0; var3 < var2.limit(); ++var3) {
            ...
            this.monitors.put(var4, monitorCreator.createMonitor(var4));
         }
      }
   ...
   public Monitor findBestMonitor(Window window) {
      long var2 = GLFW.glfwGetWindowMonitor(window.getWindow());
      if(var2 != 0L) {
         return this.getMonitor(var2);
      } else {
         int var4 = window.getX();
         int var5 = var4 + window.getScreenWidth();
         int var6 = window.getY();
         int var7 = var6 + window.getScreenHeight();
         int var8 = -1;
         Monitor var9 = null;
