...
public class RenderTarget {
   ...
   public RenderTarget(int var1, int var2, boolean useDepth, boolean var4) {
   ...
   public void resize(int viewWidth, int viewHeight, boolean var3) {
      if(!GLX.isUsingFBOs()) {
         ...
         this.createBuffers(viewWidth, viewHeight, var3);
   ...
   public void createBuffers(int viewWidth, int viewHeight, boolean var3) {
      this.viewWidth = viewWidth;
      this.viewHeight = viewHeight;
      ...
      if(!GLX.isUsingFBOs()) {
         ...
         GlStateManager.texImage2D(3553, 0, '聘', this.width, this.height, 0, 6408, 5121, (IntBuffer)null);
         ...
         if(this.useDepth) {
            ...
            GLX.glRenderbufferStorage(GLX.GL_RENDERBUFFER, '膦', this.width, this.height);
   ...
   public void setFilterMode(int filterMode) {
      if(GLX.isUsingFBOs()) {
         ...
         GlStateManager.bindTexture(this.colorTextureId);
         GlStateManager.texParameter(3553, 10241, filterMode);
         GlStateManager.texParameter(3553, 10240, filterMode);
   ...
   public void bindWrite(boolean b) {
      if(GLX.isUsingFBOs()) {
         GLX.glBindFramebuffer(GLX.GL_FRAMEBUFFER, this.frameBufferId);
         if(b) {
