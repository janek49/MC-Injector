...
public class DefaultVertexFormat {
   ...
   public static final VertexFormat POSITION_TEX_NORMAL = (new VertexFormat()).addElement(ELEMENT_POSITION).addElement(ELEMENT_UV0).addElement(ELEMENT_NORMAL).addElement(ELEMENT_PADDING);
   public static final VertexFormat POSITION_TEX2_COLOR = (new VertexFormat()).addElement(ELEMENT_POSITION).addElement(ELEMENT_UV0).addElement(ELEMENT_UV1).addElement(ELEMENT_COLOR);
   public static final VertexFormat POSITION_TEX_COLOR_NORMAL = (new VertexFormat()).addElement(ELEMENT_POSITION).addElement(ELEMENT_UV0).addElement(ELEMENT_COLOR).addElement(ELEMENT_NORMAL).addElement(ELEMENT_PADDING);
}
