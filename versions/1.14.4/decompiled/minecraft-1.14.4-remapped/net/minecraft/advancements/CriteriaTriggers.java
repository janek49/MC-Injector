...
public class CriteriaTriggers {
   ...
   private static CriterionTrigger register(CriterionTrigger criterionTrigger) {
   ...
   @Nullable
   public static CriterionTrigger getCriterion(ResourceLocation resourceLocation) {
      return (CriterionTrigger)CRITERIA.get(resourceLocation);
   }
