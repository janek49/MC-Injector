...
public class FilledBucketTrigger implements CriterionTrigger {
   ...
   public void addPlayerListener(PlayerAdvancements playerAdvancements, CriterionTrigger.Listener criterionTrigger$Listener) {
      FilledBucketTrigger.PlayerListeners var3 = (FilledBucketTrigger.PlayerListeners)this.players.get(playerAdvancements);
      if(var3 == null) {
         var3 = new FilledBucketTrigger.PlayerListeners(playerAdvancements);
   ...
   public void trigger(ServerPlayer serverPlayer, ItemStack itemStack) {
      FilledBucketTrigger.PlayerListeners var3 = (FilledBucketTrigger.PlayerListeners)this.players.get(serverPlayer.getAdvancements());
      if(var3 != null) {
   ...
   static class PlayerListeners {
      ...
      public void trigger(ItemStack itemStack) {
         List<CriterionTrigger.Listener<FilledBucketTrigger.TriggerInstance>> var2 = null;

         for(CriterionTrigger.Listener<FilledBucketTrigger.TriggerInstance> var4 : this.listeners) {
            if(((FilledBucketTrigger.TriggerInstance)var4.getTriggerInstance()).matches(itemStack)) {
               if(var2 == null) {
         ...
         if(var2 != null) {
            for(CriterionTrigger.Listener<FilledBucketTrigger.TriggerInstance> var4 : var2) {
