...
public class ShotCrossbowTrigger implements CriterionTrigger {
   ...
   public void addPlayerListener(PlayerAdvancements playerAdvancements, CriterionTrigger.Listener criterionTrigger$Listener) {
      ShotCrossbowTrigger.PlayerListeners var3 = (ShotCrossbowTrigger.PlayerListeners)this.players.get(playerAdvancements);
      if(var3 == null) {
         var3 = new ShotCrossbowTrigger.PlayerListeners(playerAdvancements);
   ...
   public void trigger(ServerPlayer serverPlayer, ItemStack itemStack) {
      ShotCrossbowTrigger.PlayerListeners var3 = (ShotCrossbowTrigger.PlayerListeners)this.players.get(serverPlayer.getAdvancements());
      if(var3 != null) {
   ...
   static class PlayerListeners {
      ...
      public void trigger(ItemStack itemStack) {
         List<CriterionTrigger.Listener<ShotCrossbowTrigger.TriggerInstance>> var2 = null;

         for(CriterionTrigger.Listener<ShotCrossbowTrigger.TriggerInstance> var4 : this.listeners) {
            if(((ShotCrossbowTrigger.TriggerInstance)var4.getTriggerInstance()).matches(itemStack)) {
               if(var2 == null) {
         ...
         if(var2 != null) {
            for(CriterionTrigger.Listener<ShotCrossbowTrigger.TriggerInstance> var4 : var2) {
