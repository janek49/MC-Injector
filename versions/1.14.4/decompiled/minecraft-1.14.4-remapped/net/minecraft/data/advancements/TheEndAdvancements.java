...
public class TheEndAdvancements implements Consumer {
   public void accept(Consumer consumer) {
      ...
      Advancement var4 = Advancement.Builder.advancement().parent(var3).display((ItemLike)Items.ENDER_PEARL, new TranslatableComponent("advancements.end.enter_end_gateway.title", new Object[0]), new TranslatableComponent("advancements.end.enter_end_gateway.description", new Object[0]), (ResourceLocation)null, FrameType.TASK, true, true, false).addCriterion("entered_end_gateway", (CriterionTriggerInstance)EnterBlockTrigger.TriggerInstance.entersBlock(Blocks.END_GATEWAY)).save(consumer, "end/enter_end_gateway");
      ...
      Advancement var9 = Advancement.Builder.advancement().parent(var6).display((ItemLike)Items.ELYTRA, new TranslatableComponent("advancements.end.elytra.title", new Object[0]), new TranslatableComponent("advancements.end.elytra.description", new Object[0]), (ResourceLocation)null, FrameType.GOAL, true, true, false).addCriterion("elytra", (CriterionTriggerInstance)InventoryChangeTrigger.TriggerInstance.hasItem(new ItemLike[]{Items.ELYTRA})).save(consumer, "end/elytra");
      Advancement var10 = Advancement.Builder.advancement().parent(var3).display((ItemLike)Blocks.DRAGON_EGG, new TranslatableComponent("advancements.end.dragon_egg.title", new Object[0]), new TranslatableComponent("advancements.end.dragon_egg.description", new Object[0]), (ResourceLocation)null, FrameType.GOAL, true, true, false).addCriterion("dragon_egg", (CriterionTriggerInstance)InventoryChangeTrigger.TriggerInstance.hasItem(new ItemLike[]{Blocks.DRAGON_EGG})).save(consumer, "end/dragon_egg");
   }
