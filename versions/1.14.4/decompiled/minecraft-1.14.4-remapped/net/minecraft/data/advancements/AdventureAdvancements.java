...
public class AdventureAdvancements implements Consumer {
   ...
   public void accept(Consumer consumer) {
      ...
      Advancement var6 = this.addMobsToKill(Advancement.Builder.advancement()).parent(var2).display((ItemLike)Items.IRON_SWORD, new TranslatableComponent("advancements.adventure.kill_a_mob.title", new Object[0]), new TranslatableComponent("advancements.adventure.kill_a_mob.description", new Object[0]), (ResourceLocation)null, FrameType.TASK, true, true, false).requirements(RequirementsStrategy.OR).save(consumer, "adventure/kill_a_mob");
      ...
      Advancement var18 = Advancement.Builder.advancement().parent(var2).display((ItemStack)Raid.getLeaderBannerInstance(), new TranslatableComponent("advancements.adventure.voluntary_exile.title", new Object[0]), new TranslatableComponent("advancements.adventure.voluntary_exile.description", new Object[0]), (ResourceLocation)null, FrameType.TASK, true, true, true).addCriterion("voluntary_exile", (CriterionTriggerInstance)KilledTrigger.TriggerInstance.playerKilledEntity(EntityPredicate.Builder.entity().of(EntityTypeTags.RAIDERS).equipment(EntityEquipmentPredicate.CAPTAIN))).save(consumer, "adventure/voluntary_exile");
   ...
   private Advancement.Builder addMobsToKill(Advancement.Builder advancement$Builder) {
      for(EntityType<?> var5 : MOBS_TO_KILL) {
         advancement$Builder.addCriterion(Registry.ENTITY_TYPE.getKey(var5).toString(), (CriterionTriggerInstance)KilledTrigger.TriggerInstance.playerKilledEntity(EntityPredicate.Builder.entity().of(var5)));
      }

      return advancement$Builder;
   }

   private Advancement.Builder addBiomes(Advancement.Builder advancement$Builder) {
      for(Biome var5 : EXPLORABLE_BIOMES) {
         advancement$Builder.addCriterion(Registry.BIOME.getKey(var5).toString(), (CriterionTriggerInstance)LocationTrigger.TriggerInstance.located(LocationPredicate.inBiome(var5)));
      }
