...
public class NetherAdvancements implements Consumer {
   public void accept(Consumer consumer) {
      ...
      Advancement var9 = Advancement.Builder.advancement().parent(var4).display((ItemLike)Items.BLAZE_ROD, new TranslatableComponent("advancements.nether.obtain_blaze_rod.title", new Object[0]), new TranslatableComponent("advancements.nether.obtain_blaze_rod.description", new Object[0]), (ResourceLocation)null, FrameType.TASK, true, true, false).addCriterion("blaze_rod", (CriterionTriggerInstance)InventoryChangeTrigger.TriggerInstance.hasItem(new ItemLike[]{Items.BLAZE_ROD})).save(consumer, "nether/obtain_blaze_rod");
      Advancement var10 = Advancement.Builder.advancement().parent(var8).display((ItemLike)Blocks.BEACON, new TranslatableComponent("advancements.nether.create_beacon.title", new Object[0]), new TranslatableComponent("advancements.nether.create_beacon.description", new Object[0]), (ResourceLocation)null, FrameType.TASK, true, true, false).addCriterion("beacon", (CriterionTriggerInstance)ConstructBeaconTrigger.TriggerInstance.constructedBeacon(MinMaxBounds.Ints.atLeast(1))).save(consumer, "nether/create_beacon");
      Advancement var11 = Advancement.Builder.advancement().parent(var10).display((ItemLike)Blocks.BEACON, new TranslatableComponent("advancements.nether.create_full_beacon.title", new Object[0]), new TranslatableComponent("advancements.nether.create_full_beacon.description", new Object[0]), (ResourceLocation)null, FrameType.GOAL, true, true, false).addCriterion("beacon", (CriterionTriggerInstance)ConstructBeaconTrigger.TriggerInstance.constructedBeacon(MinMaxBounds.Ints.exactly(4))).save(consumer, "nether/create_full_beacon");
