...
public class CommandsReport implements DataProvider {
   ...
   public void run(HashCache hashCache) throws IOException {
      ...
      DedicatedServerSettings var7 = new DedicatedServerSettings(Paths.get("server.properties", new String[0]));
      MinecraftServer var8 = new DedicatedServer(var5, var7, DataFixers.getDataFixer(), var2, var3, var4, var6, LoggerChunkProgressListener::<init>, var7.getProperties().levelName);
      Path var9 = this.generator.getOutputFolder().resolve("reports/commands.json");
      CommandDispatcher<CommandSourceStack> var10 = var8.getCommands().getDispatcher();
      DataProvider.save(GSON, hashCache, ArgumentTypes.serializeNodeToJson(var10, var10.getRoot()), var9);
   }
