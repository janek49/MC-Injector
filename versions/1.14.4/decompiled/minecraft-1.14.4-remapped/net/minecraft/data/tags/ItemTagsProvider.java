...
public class ItemTagsProvider extends TagsProvider {
   ...
   protected void addTags() {
      ...
      this.tag(ItemTags.BANNERS).add((Object[])(new Item[]{Items.WHITE_BANNER, Items.ORANGE_BANNER, Items.MAGENTA_BANNER, Items.LIGHT_BLUE_BANNER, Items.YELLOW_BANNER, Items.LIME_BANNER, Items.PINK_BANNER, Items.GRAY_BANNER, Items.LIGHT_GRAY_BANNER, Items.CYAN_BANNER, Items.PURPLE_BANNER, Items.BLUE_BANNER, Items.BROWN_BANNER, Items.GREEN_BANNER, Items.RED_BANNER, Items.BLACK_BANNER}));
      this.tag(ItemTags.BOATS).add((Object[])(new Item[]{Items.OAK_BOAT, Items.SPRUCE_BOAT, Items.BIRCH_BOAT, Items.JUNGLE_BOAT, Items.ACACIA_BOAT, Items.DARK_OAK_BOAT}));
      this.tag(ItemTags.FISHES).add((Object[])(new Item[]{Items.COD, Items.COOKED_COD, Items.SALMON, Items.COOKED_SALMON, Items.PUFFERFISH, Items.TROPICAL_FISH}));
      this.copy(BlockTags.STANDING_SIGNS, ItemTags.SIGNS);
      this.tag(ItemTags.MUSIC_DISCS).add((Object[])(new Item[]{Items.MUSIC_DISC_13, Items.MUSIC_DISC_CAT, Items.MUSIC_DISC_BLOCKS, Items.MUSIC_DISC_CHIRP, Items.MUSIC_DISC_FAR, Items.MUSIC_DISC_MALL, Items.MUSIC_DISC_MELLOHI, Items.MUSIC_DISC_STAL, Items.MUSIC_DISC_STRAD, Items.MUSIC_DISC_WARD, Items.MUSIC_DISC_11, Items.MUSIC_DISC_WAIT}));
      this.tag(ItemTags.COALS).add((Object[])(new Item[]{Items.COAL, Items.CHARCOAL}));
      this.tag(ItemTags.ARROWS).add((Object[])(new Item[]{Items.ARROW, Items.TIPPED_ARROW, Items.SPECTRAL_ARROW}));
   }

   protected void copy(Tag var1, Tag var2) {
      Tag.Builder<Item> var3 = this.tag(var2);

      for(Tag.Entry<Block> var5 : var1.getSource()) {
         Tag.Entry<Item> var6 = this.copy(var5);
         var3.add(var6);
      }

   }

   private Tag.Entry copy(Tag.Entry tag$Entry) {
      if(tag$Entry instanceof Tag.TagEntry) {
         return new Tag.TagEntry(((Tag.TagEntry)tag$Entry).getId());
      } else if(tag$Entry instanceof Tag.ValuesEntry) {
         List<Item> var2 = Lists.newArrayList();

         for(Block var4 : ((Tag.ValuesEntry)tag$Entry).getValues()) {
         ...
         throw new UnsupportedOperationException("Unknown tag entry " + tag$Entry);
      }
   }
