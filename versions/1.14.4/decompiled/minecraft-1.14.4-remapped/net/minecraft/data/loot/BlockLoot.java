...
public class BlockLoot implements Consumer {
   ...
   private static final LootItemCondition.Builder HAS_SHEARS = MatchTool.toolMatches(ItemPredicate.Builder.item().of((ItemLike)Items.SHEARS));
   private static final LootItemCondition.Builder HAS_SHEARS_OR_SILK_TOUCH = HAS_SHEARS.or(HAS_SILK_TOUCH);
   private static final LootItemCondition.Builder HAS_NO_SHEARS_OR_SILK_TOUCH = HAS_SHEARS_OR_SILK_TOUCH.invert();
   private static final Set EXPLOSION_RESISTANT = (Set)Stream.of(new Block[]{Blocks.DRAGON_EGG, Blocks.BEACON, Blocks.CONDUIT, Blocks.SKELETON_SKULL, Blocks.WITHER_SKELETON_SKULL, Blocks.PLAYER_HEAD, Blocks.ZOMBIE_HEAD, Blocks.CREEPER_HEAD, Blocks.DRAGON_HEAD, Blocks.SHULKER_BOX, Blocks.BLACK_SHULKER_BOX, Blocks.BLUE_SHULKER_BOX, Blocks.BROWN_SHULKER_BOX, Blocks.CYAN_SHULKER_BOX, Blocks.GRAY_SHULKER_BOX, Blocks.GREEN_SHULKER_BOX, Blocks.LIGHT_BLUE_SHULKER_BOX, Blocks.LIGHT_GRAY_SHULKER_BOX, Blocks.LIME_SHULKER_BOX, Blocks.MAGENTA_SHULKER_BOX, Blocks.ORANGE_SHULKER_BOX, Blocks.PINK_SHULKER_BOX, Blocks.PURPLE_SHULKER_BOX, Blocks.RED_SHULKER_BOX, Blocks.WHITE_SHULKER_BOX, Blocks.YELLOW_SHULKER_BOX}).map(ItemLike::asItem).collect(ImmutableSet.toImmutableSet());
   private static final float[] NORMAL_LEAVES_SAPLING_CHANCES = new float[]{0.05F, 0.0625F, 0.083333336F, 0.1F};
   private static final float[] JUNGLE_LEAVES_SAPLING_CHANGES = new float[]{0.025F, 0.027777778F, 0.03125F, 0.041666668F, 0.1F};
   private final Map map = Maps.newHashMap();

   private static Object applyExplosionDecay(ItemLike itemLike, FunctionUserBuilder functionUserBuilder) {
   ...
   private static Object applyExplosionCondition(ItemLike itemLike, ConditionUserBuilder conditionUserBuilder) {
   ...
   private static LootTable.Builder createSelfDropDispatchTable(Block block, LootItemCondition.Builder lootItemCondition$Builder, LootPoolEntryContainer.Builder lootPoolEntryContainer$Builder) {
      return LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantIntValue.exactly(1)).add(((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(block).when(lootItemCondition$Builder)).otherwise(lootPoolEntryContainer$Builder)));
   }

   private static LootTable.Builder createSilkTouchDispatchTable(Block block, LootPoolEntryContainer.Builder lootPoolEntryContainer$Builder) {
      return createSelfDropDispatchTable(block, HAS_SILK_TOUCH, lootPoolEntryContainer$Builder);
   }

   private static LootTable.Builder createShearsDispatchTable(Block block, LootPoolEntryContainer.Builder lootPoolEntryContainer$Builder) {
      return createSelfDropDispatchTable(block, HAS_SHEARS, lootPoolEntryContainer$Builder);
   }

   private static LootTable.Builder createSilkTouchOrShearsDispatchTable(Block block, LootPoolEntryContainer.Builder lootPoolEntryContainer$Builder) {
      return createSelfDropDispatchTable(block, HAS_SHEARS_OR_SILK_TOUCH, lootPoolEntryContainer$Builder);
   }
   ...
   private static LootTable.Builder createSingleItemTable(ItemLike itemLike, RandomIntGenerator randomIntGenerator) {
      return LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantIntValue.exactly(1)).add((LootPoolEntryContainer.Builder)applyExplosionDecay(itemLike, LootItem.lootTableItem(itemLike).apply(SetItemCountFunction.setCount(randomIntGenerator)))));
   }
   ...
   private static LootTable.Builder createSingleItemTableWithSilkTouch(Block block, ItemLike itemLike, RandomIntGenerator randomIntGenerator) {
      return createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)applyExplosionDecay(block, LootItem.lootTableItem(itemLike).apply(SetItemCountFunction.setCount(randomIntGenerator))));
   }
   ...
   private static LootTable.Builder createSlabItemTable(Block block) {
      return LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantIntValue.exactly(1)).add((LootPoolEntryContainer.Builder)applyExplosionDecay(block, LootItem.lootTableItem(block).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(2)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SlabBlock.TYPE, SlabType.DOUBLE))))));
   }

   private static LootTable.Builder createSinglePropConditionTable(Block block, Property property, Comparable comparable) {
      return LootTable.lootTable().withPool((LootPool.Builder)applyExplosionCondition(block, LootPool.lootPool().setRolls(ConstantIntValue.exactly(1)).add(LootItem.lootTableItem(block).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(property, comparable)))));
   }

   private static LootTable.Builder createNameableBlockEntityTable(Block block) {
      return LootTable.lootTable().withPool((LootPool.Builder)applyExplosionCondition(block, LootPool.lootPool().setRolls(ConstantIntValue.exactly(1)).add(LootItem.lootTableItem(block).apply(CopyNameFunction.copyName(CopyNameFunction.NameSource.BLOCK_ENTITY)))));
   }
   ...
   private static LootTable.Builder createOreDrop(Block block, Item item) {
      return createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)applyExplosionDecay(block, LootItem.lootTableItem(item).apply(ApplyBonusCount.addOreBonusCount(Enchantments.BLOCK_FORTUNE))));
   }

   private static LootTable.Builder createMushroomBlockDrop(Block block, ItemLike itemLike) {
      return createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)applyExplosionDecay(block, LootItem.lootTableItem(itemLike).apply(SetItemCountFunction.setCount(RandomValueBounds.between(-6.0F, 2.0F))).apply(LimitCount.limitCount(IntLimiter.lowerBound(0)))));
   }

   private static LootTable.Builder createGrassDrops(Block block) {
      return createShearsDispatchTable(block, (LootPoolEntryContainer.Builder)applyExplosionDecay(block, ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.WHEAT_SEEDS).when(LootItemRandomChanceCondition.randomChance(0.125F))).apply(ApplyBonusCount.addUniformBonusCount(Enchantments.BLOCK_FORTUNE, 2))));
   }

   private static LootTable.Builder createStemDrops(Block block, Item item) {
      return LootTable.lootTable().withPool((LootPool.Builder)applyExplosionDecay(block, LootPool.lootPool().setRolls(ConstantIntValue.exactly(1)).add(LootItem.lootTableItem(item).apply(SetItemCountFunction.setCount(BinomialDistributionGenerator.binomial(3, 0.06666667F)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(StemBlock.AGE, Integer.valueOf(0)))).apply(SetItemCountFunction.setCount(BinomialDistributionGenerator.binomial(3, 0.13333334F)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(StemBlock.AGE, Integer.valueOf(1)))).apply(SetItemCountFunction.setCount(BinomialDistributionGenerator.binomial(3, 0.2F)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(StemBlock.AGE, Integer.valueOf(2)))).apply(SetItemCountFunction.setCount(BinomialDistributionGenerator.binomial(3, 0.26666668F)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(StemBlock.AGE, Integer.valueOf(3)))).apply(SetItemCountFunction.setCount(BinomialDistributionGenerator.binomial(3, 0.33333334F)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(StemBlock.AGE, Integer.valueOf(4)))).apply(SetItemCountFunction.setCount(BinomialDistributionGenerator.binomial(3, 0.4F)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(StemBlock.AGE, Integer.valueOf(5)))).apply(SetItemCountFunction.setCount(BinomialDistributionGenerator.binomial(3, 0.46666667F)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(StemBlock.AGE, Integer.valueOf(6)))).apply(SetItemCountFunction.setCount(BinomialDistributionGenerator.binomial(3, 0.53333336F)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(StemBlock.AGE, Integer.valueOf(7)))))));
   }
   ...
   public void accept(BiConsumer biConsumer) {
      ...
      this.add(Blocks.STONE, (block) -> {
         return createSingleItemTableWithSilkTouch(block, Blocks.COBBLESTONE);
      });
      this.add(Blocks.GRASS_BLOCK, (block) -> {
         return createSingleItemTableWithSilkTouch(block, Blocks.DIRT);
      });
      this.add(Blocks.PODZOL, (block) -> {
         return createSingleItemTableWithSilkTouch(block, Blocks.DIRT);
      });
      this.add(Blocks.MYCELIUM, (block) -> {
         return createSingleItemTableWithSilkTouch(block, Blocks.DIRT);
      });
      this.add(Blocks.TUBE_CORAL_BLOCK, (block) -> {
         return createSingleItemTableWithSilkTouch(block, Blocks.DEAD_TUBE_CORAL_BLOCK);
      });
      this.add(Blocks.BRAIN_CORAL_BLOCK, (block) -> {
         return createSingleItemTableWithSilkTouch(block, Blocks.DEAD_BRAIN_CORAL_BLOCK);
      });
      this.add(Blocks.BUBBLE_CORAL_BLOCK, (block) -> {
         return createSingleItemTableWithSilkTouch(block, Blocks.DEAD_BUBBLE_CORAL_BLOCK);
      });
      this.add(Blocks.FIRE_CORAL_BLOCK, (block) -> {
         return createSingleItemTableWithSilkTouch(block, Blocks.DEAD_FIRE_CORAL_BLOCK);
      });
      this.add(Blocks.HORN_CORAL_BLOCK, (block) -> {
         return createSingleItemTableWithSilkTouch(block, Blocks.DEAD_HORN_CORAL_BLOCK);
      });
      this.add(Blocks.BOOKSHELF, (block) -> {
         return createSingleItemTableWithSilkTouch(block, Items.BOOK, ConstantIntValue.exactly(3));
      });
      this.add(Blocks.CLAY, (block) -> {
         return createSingleItemTableWithSilkTouch(block, Items.CLAY_BALL, ConstantIntValue.exactly(4));
      });
      this.add(Blocks.ENDER_CHEST, (block) -> {
         return createSingleItemTableWithSilkTouch(block, Blocks.OBSIDIAN, ConstantIntValue.exactly(8));
      });
      this.add(Blocks.SNOW_BLOCK, (block) -> {
         return createSingleItemTableWithSilkTouch(block, Items.SNOWBALL, ConstantIntValue.exactly(4));
      });
      ...
      this.add(Blocks.ACACIA_DOOR, (block) -> {
         return createSinglePropConditionTable(block, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.add(Blocks.BIRCH_DOOR, (block) -> {
         return createSinglePropConditionTable(block, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.add(Blocks.DARK_OAK_DOOR, (block) -> {
         return createSinglePropConditionTable(block, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.add(Blocks.IRON_DOOR, (block) -> {
         return createSinglePropConditionTable(block, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.add(Blocks.JUNGLE_DOOR, (block) -> {
         return createSinglePropConditionTable(block, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.add(Blocks.OAK_DOOR, (block) -> {
         return createSinglePropConditionTable(block, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.add(Blocks.SPRUCE_DOOR, (block) -> {
         return createSinglePropConditionTable(block, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.add(Blocks.BLACK_BED, (block) -> {
         return createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD);
      });
      this.add(Blocks.BLUE_BED, (block) -> {
         return createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD);
      });
      this.add(Blocks.BROWN_BED, (block) -> {
         return createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD);
      });
      this.add(Blocks.CYAN_BED, (block) -> {
         return createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD);
      });
      this.add(Blocks.GRAY_BED, (block) -> {
         return createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD);
      });
      this.add(Blocks.GREEN_BED, (block) -> {
         return createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD);
      });
      this.add(Blocks.LIGHT_BLUE_BED, (block) -> {
         return createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD);
      });
      this.add(Blocks.LIGHT_GRAY_BED, (block) -> {
         return createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD);
      });
      this.add(Blocks.LIME_BED, (block) -> {
         return createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD);
      });
      this.add(Blocks.MAGENTA_BED, (block) -> {
         return createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD);
      });
      this.add(Blocks.PURPLE_BED, (block) -> {
         return createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD);
      });
      this.add(Blocks.ORANGE_BED, (block) -> {
         return createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD);
      });
      this.add(Blocks.PINK_BED, (block) -> {
         return createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD);
      });
      this.add(Blocks.RED_BED, (block) -> {
         return createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD);
      });
      this.add(Blocks.WHITE_BED, (block) -> {
         return createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD);
      });
      this.add(Blocks.YELLOW_BED, (block) -> {
         return createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD);
      });
      this.add(Blocks.LILAC, (block) -> {
         return createSinglePropConditionTable(block, DoublePlantBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.add(Blocks.SUNFLOWER, (block) -> {
         return createSinglePropConditionTable(block, DoublePlantBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.add(Blocks.PEONY, (block) -> {
         return createSinglePropConditionTable(block, DoublePlantBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.add(Blocks.ROSE_BUSH, (block) -> {
         return createSinglePropConditionTable(block, DoublePlantBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.add(Blocks.TNT, (block) -> {
         return createSinglePropConditionTable(block, TntBlock.UNSTABLE, Boolean.valueOf(false));
      });
      this.add(Blocks.COCOA, (block) -> {
         return LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantIntValue.exactly(1)).add((LootPoolEntryContainer.Builder)applyExplosionDecay(block, LootItem.lootTableItem(Items.COCOA_BEANS).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(3)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(CocoaBlock.AGE, Integer.valueOf(2)))))));
      });
      this.add(Blocks.SEA_PICKLE, (block) -> {
         return LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantIntValue.exactly(1)).add((LootPoolEntryContainer.Builder)applyExplosionDecay(block, LootItem.lootTableItem(block).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(2)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SeaPickleBlock.PICKLES, Integer.valueOf(2)))).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(3)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SeaPickleBlock.PICKLES, Integer.valueOf(3)))).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(4)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SeaPickleBlock.PICKLES, Integer.valueOf(4)))))));
      });
      this.add(Blocks.COMPOSTER, (block) -> {
         return LootTable.lootTable().withPool(LootPool.lootPool().add((LootPoolEntryContainer.Builder)applyExplosionDecay(block, LootItem.lootTableItem(Items.COMPOSTER)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.BONE_MEAL)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(ComposterBlock.LEVEL, Integer.valueOf(8))));
      });
      ...
      this.add(Blocks.PLAYER_HEAD, (block) -> {
         return LootTable.lootTable().withPool((LootPool.Builder)applyExplosionCondition(block, LootPool.lootPool().setRolls(ConstantIntValue.exactly(1)).add(LootItem.lootTableItem(block).apply(CopyNbtFunction.copyData(CopyNbtFunction.DataSource.BLOCK_ENTITY).copy("Owner", "SkullOwner")))));
      });
      this.add(Blocks.BIRCH_LEAVES, (block) -> {
         return createLeavesDrops(block, Blocks.BIRCH_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES);
      });
      this.add(Blocks.ACACIA_LEAVES, (block) -> {
         return createLeavesDrops(block, Blocks.ACACIA_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES);
      });
      this.add(Blocks.JUNGLE_LEAVES, (block) -> {
         return createLeavesDrops(block, Blocks.JUNGLE_SAPLING, JUNGLE_LEAVES_SAPLING_CHANGES);
      });
      this.add(Blocks.SPRUCE_LEAVES, (block) -> {
         return createLeavesDrops(block, Blocks.SPRUCE_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES);
      });
      this.add(Blocks.OAK_LEAVES, (block) -> {
         return createOakLeavesDrops(block, Blocks.OAK_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES);
      });
      this.add(Blocks.DARK_OAK_LEAVES, (block) -> {
         return createOakLeavesDrops(block, Blocks.DARK_OAK_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES);
      });
      LootItemCondition.Builder var2 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.BEETROOTS).withProperty(BeetrootBlock.AGE, Integer.valueOf(3));
      this.add(Blocks.BEETROOTS, (block) -> {
         return createCropDrops(block, Items.BEETROOT, Items.BEETROOT_SEEDS, var2);
      });
      LootItemCondition.Builder var3 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.WHEAT).withProperty(CropBlock.AGE, Integer.valueOf(7));
      this.add(Blocks.WHEAT, (block) -> {
         return createCropDrops(block, Items.WHEAT, Items.WHEAT_SEEDS, var3);
      });
      LootItemCondition.Builder var4 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.CARROTS).withProperty(CarrotBlock.AGE, Integer.valueOf(7));
      this.add(Blocks.CARROTS, (block) -> {
         return (LootTable.Builder)applyExplosionDecay(block, LootTable.lootTable().withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.CARROT))).withPool(LootPool.lootPool().when(var4).add(LootItem.lootTableItem(Items.CARROT).apply(ApplyBonusCount.addBonusBinomialDistributionCount(Enchantments.BLOCK_FORTUNE, 0.5714286F, 3)))));
      });
      LootItemCondition.Builder var5 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.POTATOES).withProperty(PotatoBlock.AGE, Integer.valueOf(7));
      this.add(Blocks.POTATOES, (block) -> {
         return (LootTable.Builder)applyExplosionDecay(block, LootTable.lootTable().withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.POTATO))).withPool(LootPool.lootPool().when(var5).add(LootItem.lootTableItem(Items.POTATO).apply(ApplyBonusCount.addBonusBinomialDistributionCount(Enchantments.BLOCK_FORTUNE, 0.5714286F, 3)))).withPool(LootPool.lootPool().when(var5).add(LootItem.lootTableItem(Items.POISONOUS_POTATO).when(LootItemRandomChanceCondition.randomChance(0.02F)))));
      });
      this.add(Blocks.SWEET_BERRY_BUSH, (block) -> {
         return (LootTable.Builder)applyExplosionDecay(block, LootTable.lootTable().withPool(LootPool.lootPool().when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.SWEET_BERRY_BUSH).withProperty(SweetBerryBushBlock.AGE, Integer.valueOf(3))).add(LootItem.lootTableItem(Items.SWEET_BERRIES)).apply(SetItemCountFunction.setCount(RandomValueBounds.between(2.0F, 3.0F))).apply(ApplyBonusCount.addUniformBonusCount(Enchantments.BLOCK_FORTUNE))).withPool(LootPool.lootPool().when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.SWEET_BERRY_BUSH).withProperty(SweetBerryBushBlock.AGE, Integer.valueOf(2))).add(LootItem.lootTableItem(Items.SWEET_BERRIES)).apply(SetItemCountFunction.setCount(RandomValueBounds.between(1.0F, 2.0F))).apply(ApplyBonusCount.addUniformBonusCount(Enchantments.BLOCK_FORTUNE))));
      });
      this.add(Blocks.BROWN_MUSHROOM_BLOCK, (block) -> {
         return createMushroomBlockDrop(block, Blocks.BROWN_MUSHROOM);
      });
      this.add(Blocks.RED_MUSHROOM_BLOCK, (block) -> {
         return createMushroomBlockDrop(block, Blocks.RED_MUSHROOM);
      });
      this.add(Blocks.COAL_ORE, (block) -> {
         return createOreDrop(block, Items.COAL);
      });
      this.add(Blocks.EMERALD_ORE, (block) -> {
         return createOreDrop(block, Items.EMERALD);
      });
      this.add(Blocks.NETHER_QUARTZ_ORE, (block) -> {
         return createOreDrop(block, Items.QUARTZ);
      });
      this.add(Blocks.DIAMOND_ORE, (block) -> {
         return createOreDrop(block, Items.DIAMOND);
      });
      this.add(Blocks.LAPIS_ORE, (block) -> {
         return createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)applyExplosionDecay(block, LootItem.lootTableItem(Items.LAPIS_LAZULI).apply(SetItemCountFunction.setCount(RandomValueBounds.between(4.0F, 9.0F))).apply(ApplyBonusCount.addOreBonusCount(Enchantments.BLOCK_FORTUNE))));
      });
      this.add(Blocks.COBWEB, (block) -> {
         return createSilkTouchOrShearsDispatchTable(block, (LootPoolEntryContainer.Builder)applyExplosionCondition(block, LootItem.lootTableItem(Items.STRING)));
      });
      this.add(Blocks.DEAD_BUSH, (block) -> {
         return createShearsDispatchTable(block, (LootPoolEntryContainer.Builder)applyExplosionDecay(block, LootItem.lootTableItem(Items.STICK).apply(SetItemCountFunction.setCount(RandomValueBounds.between(0.0F, 2.0F)))));
      });
      ...
      this.add(Blocks.TALL_GRASS, (block) -> {
         return createShearsDispatchTable(Blocks.GRASS, ((LootPoolSingletonContainer.Builder)((LootPoolSingletonContainer.Builder)applyExplosionCondition(block, LootItem.lootTableItem(Items.WHEAT_SEEDS))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(DoublePlantBlock.HALF, DoubleBlockHalf.LOWER))).when(LootItemRandomChanceCondition.randomChance(0.125F)));
      });
      this.add(Blocks.MELON_STEM, (block) -> {
         return createStemDrops(block, Items.MELON_SEEDS);
      });
      this.add(Blocks.PUMPKIN_STEM, (block) -> {
         return createStemDrops(block, Items.PUMPKIN_SEEDS);
      });
      this.add(Blocks.CHORUS_FLOWER, (block) -> {
         return LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantIntValue.exactly(1)).add(((LootPoolSingletonContainer.Builder)applyExplosionCondition(block, LootItem.lootTableItem(block))).when(LootItemEntityPropertyCondition.entityPresent(LootContext.EntityTarget.THIS))));
      });
      this.add(Blocks.FERN, BlockLoot::createGrassDrops);
      this.add(Blocks.GRASS, BlockLoot::createGrassDrops);
      this.add(Blocks.GLOWSTONE, (block) -> {
      ...
      this.add(Blocks.REDSTONE_ORE, (block) -> {
         return createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)applyExplosionDecay(block, LootItem.lootTableItem(Items.REDSTONE).apply(SetItemCountFunction.setCount(RandomValueBounds.between(4.0F, 5.0F))).apply(ApplyBonusCount.addUniformBonusCount(Enchantments.BLOCK_FORTUNE))));
      });
      this.add(Blocks.SEA_LANTERN, (block) -> {
      ...
      this.add(Blocks.NETHER_WART, (block) -> {
         return LootTable.lootTable().withPool((LootPool.Builder)applyExplosionDecay(block, LootPool.lootPool().setRolls(ConstantIntValue.exactly(1)).add(LootItem.lootTableItem(Items.NETHER_WART).apply(SetItemCountFunction.setCount(RandomValueBounds.between(2.0F, 4.0F)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(NetherWartBlock.AGE, Integer.valueOf(3)))).apply(ApplyBonusCount.addUniformBonusCount(Enchantments.BLOCK_FORTUNE).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(NetherWartBlock.AGE, Integer.valueOf(3)))))));
      });
      this.add(Blocks.SNOW, (block) -> {
         return LootTable.lootTable().withPool(LootPool.lootPool().when(LootItemEntityPropertyCondition.entityPresent(LootContext.EntityTarget.THIS)).add(AlternativesEntry.alternatives(new LootPoolEntryContainer.Builder[]{AlternativesEntry.alternatives(new LootPoolEntryContainer.Builder[]{LootItem.lootTableItem(Items.SNOWBALL).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, Integer.valueOf(1))), ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.SNOWBALL).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, Integer.valueOf(2)))).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(2))), ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.SNOWBALL).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, Integer.valueOf(3)))).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(3))), ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.SNOWBALL).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, Integer.valueOf(4)))).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(4))), ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.SNOWBALL).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, Integer.valueOf(5)))).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(5))), ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.SNOWBALL).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, Integer.valueOf(6)))).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(6))), ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.SNOWBALL).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, Integer.valueOf(7)))).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(7))), LootItem.lootTableItem(Items.SNOWBALL).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(8)))}).when(HAS_NO_SILK_TOUCH), AlternativesEntry.alternatives(new LootPoolEntryContainer.Builder[]{LootItem.lootTableItem(block).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, Integer.valueOf(1))), LootItem.lootTableItem(block).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(2))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, Integer.valueOf(2))), LootItem.lootTableItem(block).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(3))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, Integer.valueOf(3))), LootItem.lootTableItem(block).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(4))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, Integer.valueOf(4))), LootItem.lootTableItem(block).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(5))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, Integer.valueOf(5))), LootItem.lootTableItem(block).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(6))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, Integer.valueOf(6))), LootItem.lootTableItem(block).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(7))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).withProperty(SnowLayerBlock.LAYERS, Integer.valueOf(7))), LootItem.lootTableItem(Blocks.SNOW_BLOCK)})})));
      });
      this.add(Blocks.GRAVEL, (block) -> {
         return createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)applyExplosionCondition(block, ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.FLINT).when(BonusLevelTableCondition.bonusLevelFlatChance(Enchantments.BLOCK_FORTUNE, new float[]{0.1F, 0.14285715F, 0.25F, 1.0F}))).otherwise(LootItem.lootTableItem(block))));
      });
      this.add(Blocks.CAMPFIRE, (block) -> {
         return createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)applyExplosionCondition(block, LootItem.lootTableItem(Items.CHARCOAL).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(2)))));
      });
      ...
      for(Block var8 : Registry.BLOCK) {
         ...
         if(var9 != BuiltInLootTables.EMPTY && var6.add(var9)) {
            ...
            if(var10 == null) {
               throw new IllegalStateException(String.format("Missing loottable \'%s\' for \'%s\'", new Object[]{var9, Registry.BLOCK.getKey(var8)}));
            }

            biConsumer.accept(var9, var10);
         }
      }
   ...
   private void add(Block block, Function function) {
      this.add(block, (LootTable.Builder)function.apply(block));
   }

   private void add(Block block, LootTable.Builder lootTable$Builder) {
      this.map.put(block.getLootTable(), lootTable$Builder);
   }
