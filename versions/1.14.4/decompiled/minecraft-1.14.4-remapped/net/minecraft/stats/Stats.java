...
public class Stats {
   public static final StatType BLOCK_MINED = makeRegistryStatType("mined", Registry.BLOCK);
   public static final StatType ITEM_CRAFTED = makeRegistryStatType("crafted", Registry.ITEM);
   public static final StatType ITEM_USED = makeRegistryStatType("used", Registry.ITEM);
   public static final StatType ITEM_BROKEN = makeRegistryStatType("broken", Registry.ITEM);
   public static final StatType ITEM_PICKED_UP = makeRegistryStatType("picked_up", Registry.ITEM);
   public static final StatType ITEM_DROPPED = makeRegistryStatType("dropped", Registry.ITEM);
   public static final StatType ENTITY_KILLED = makeRegistryStatType("killed", Registry.ENTITY_TYPE);
   public static final StatType ENTITY_KILLED_BY = makeRegistryStatType("killed_by", Registry.ENTITY_TYPE);
   public static final StatType CUSTOM = makeRegistryStatType("custom", Registry.CUSTOM_STAT);
   ...
   private static ResourceLocation makeCustomStat(String string, StatFormatter statFormatter) {
      ...
      Registry.register(Registry.CUSTOM_STAT, (String)string, resourceLocation);
      CUSTOM.get(resourceLocation, statFormatter);
      return resourceLocation;
   }

   private static StatType makeRegistryStatType(String string, Registry registry) {
