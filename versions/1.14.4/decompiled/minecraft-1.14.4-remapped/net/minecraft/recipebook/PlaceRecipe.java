...
public interface PlaceRecipe {
   default void placeRecipe(int var1, int var2, int var3, Recipe recipe, Iterator iterator, int var6) {
      int var7 = var1;
      int var8 = var2;
      if(recipe instanceof ShapedRecipe) {
         ShapedRecipe var9 = (ShapedRecipe)recipe;
         var7 = var9.getWidth();
         var8 = var9.getHeight();
      }
      ...
      for(int var10 = 0; var10 < var2; ++var10) {
         ...
         for(int var13 = 0; var13 < var1; ++var13) {
            ...
            if(var15) {
               this.addItemToSlot(iterator, var9, var6, var10, var13);
            } else if(var14 == var13) {
               var9 += var1 - var13;
               break;
            }
