...
public class BitStorage {
   ...
   public BitStorage(int bits, int size, long[] data) {
      Validate.inclusiveBetween(1L, 32L, (long)bits);
      this.size = size;
      this.bits = bits;
      this.data = data;
      this.mask = (1L << bits) - 1L;
      int var4 = Mth.roundUp(size * bits, 64) / 64;
      if(data.length != var4) {
   ...
   public int get(int i) {
      ...
      int var2 = i * this.bits;
      int var3 = var2 >> 6;
      int var4 = (i + 1) * this.bits - 1 >> 6;
   ...
   public void getAll(IntConsumer intConsumer) {
      ...
      if(var2 != 0) {
         ...
         for(int var8 = 0; var8 < this.size; ++var8) {
            ...
            if(var10 == var11) {
               intConsumer.accept((int)(var4 >>> var12 & this.mask));
            } else {
               int var13 = 64 - var12;
               intConsumer.accept((int)((var4 >>> var12 | var6 << var13) & this.mask));
            }
         }
