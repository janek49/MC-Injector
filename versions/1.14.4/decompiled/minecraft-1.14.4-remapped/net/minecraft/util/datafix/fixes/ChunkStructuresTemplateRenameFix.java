...
public class ChunkStructuresTemplateRenameFix extends DataFix {
   ...
   public ChunkStructuresTemplateRenameFix(Schema schema, boolean var2) {
      super(schema, var2);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ChunkStructuresTemplateRenameFix", var1, (var2x) -> {
         return var2x.updateTyped(var2, (var2) -> {
            return var2.update(DSL.remainderFinder(), (var2) -> {
   ...
   private Dynamic fixTag(Dynamic var1, Dynamic var2) {
      ...
      if(RENAMES.containsKey(var3)) {
         Pair<String, ImmutableMap<String, String>> var4 = (Pair)RENAMES.get(var3);
