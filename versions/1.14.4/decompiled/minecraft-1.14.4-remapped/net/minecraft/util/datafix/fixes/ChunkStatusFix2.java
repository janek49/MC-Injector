...
public class ChunkStatusFix2 extends DataFix {
   ...
   public ChunkStatusFix2(Schema schema, boolean var2) {
      super(schema, var2);
   }
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ChunkStatusFix2", var1, this.getOutputSchema().getType(References.CHUNK), (var1) -> {
         return var1.updateTyped(var3, (typed) -> {
            ...
            return Objects.equals(var2, var3)?typed:typed.set(DSL.remainderFinder(), var1.set("Status", var1.createString(var3)));
         });
      });
   }
}
