...
public class EntityMinecartIdentifiersFix extends DataFix {
   ...
   public EntityMinecartIdentifiersFix(Schema schema, boolean var2) {
      super(schema, var2);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhere("EntityMinecartIdentifiersFix", var1, var2, (dynamicOps) -> {
         return (var3) -> {
            if(!Objects.equals(var3.getFirst(), "Minecart")) {
               return var3;
            } else {
               Typed<? extends Pair<String, ?>> var4 = (Typed)var1.point(dynamicOps, "Minecart", var3.getSecond()).orElseThrow(IllegalStateException::<init>);
