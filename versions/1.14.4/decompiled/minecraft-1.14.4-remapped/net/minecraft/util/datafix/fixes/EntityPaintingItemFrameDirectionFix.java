...
public class EntityPaintingItemFrameDirectionFix extends DataFix {
   ...
   public EntityPaintingItemFrameDirectionFix(Schema schema, boolean var2) {
      super(schema, var2);
   }
   ...
   private Dynamic doFix(Dynamic var1, boolean var2, boolean var3) {
      if((var2 || var3) && !var1.get("Facing").asNumber().isPresent()) {
         ...
         if(var1.get("Direction").asNumber().isPresent()) {
            ...
            int[] vars5 = DIRECTIONS[var4];
            var1 = var1.set("TileX", var1.createInt(var1.get("TileX").asInt(0) + vars5[0]));
            var1 = var1.set("TileY", var1.createInt(var1.get("TileY").asInt(0) + vars5[1]));
            var1 = var1.set("TileZ", var1.createInt(var1.get("TileZ").asInt(0) + vars5[2]));
   ...
   public TypeRewriteRule makeRule() {
      ...
      TypeRewriteRule var6 = this.fixTypeEverywhereTyped("EntityPaintingFix", var5, (var3) -> {
         return var3.updateTyped(var2, var1, (typed) -> {
      ...
      TypeRewriteRule var7 = this.fixTypeEverywhereTyped("EntityItemFrameFix", var5, (var3x) -> {
         return var3x.updateTyped(var4, var3, (typed) -> {
            return typed.update(DSL.remainderFinder(), (dynamic) -> {
