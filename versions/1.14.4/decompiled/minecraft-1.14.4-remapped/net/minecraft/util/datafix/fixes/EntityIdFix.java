...
public class EntityIdFix extends DataFix {
   ...
   public EntityIdFix(Schema schema, boolean var2) {
      super(schema, var2);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      return TypeRewriteRule.seq(this.convertUnchecked("item stack entity name hook converter", var3, var4), this.fixTypeEverywhere("EntityIdFix", var1, var2, (dynamicOps) -> {
         return (pair) -> {
