...
public class BlockEntityBlockStateFix extends NamedEntityFix {
   public BlockEntityBlockStateFix(Schema schema, boolean var2) {
      super(schema, var2, "BlockEntityBlockStateFix", References.BLOCK_ENTITY, "minecraft:piston");
   }
   ...
   protected Typed fix(Typed typed) {
      ...
      Typed<?> var9 = (Typed)var2.pointTyped(typed.getOps()).orElseThrow(() -> {
