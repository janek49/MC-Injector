...
public class StatsCounterFix extends DataFix {
   ...
   public StatsCounterFix(Schema schema, boolean var2) {
      super(schema, var2);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("StatsCounterFix", this.getInputSchema().getType(References.STATS), var1, (var2) -> {
         ...
         Map<Dynamic<?>, Dynamic<?>> var4 = Maps.newHashMap();
         Optional<? extends Map<? extends Dynamic<?>, ? extends Dynamic<?>>> var5 = var3.getMapValues();
         if(var5.isPresent()) {
            Iterator var6 = ((Map)var5.get()).entrySet().iterator();

            while(true) {
               Entry<? extends Dynamic<?>, ? extends Dynamic<?>> var7;
               String var9;
               String var10;
               while(true) {
                  if(!var6.hasNext()) {
               ...
               Dynamic<?> var11 = var3.createString(var9);
               Dynamic<?> var12 = (Dynamic)var4.computeIfAbsent(var11, (var1) -> {
                  return var3.emptyMap();
               });
               var4.put(var11, var12.set(var10, (Dynamic)var7.getValue()));
            }
         } else {
            return (Typed)((Optional)var1.readTyped(var3.emptyMap().set("stats", var3.createMap(var4))).getSecond()).orElseThrow(() -> {
               return new IllegalStateException("Could not parse new stats object.");
