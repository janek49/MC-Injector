...
public class V1460 extends NamespacedSchema {
   public V1460(int var1, Schema schema) {
      super(var1, schema);
   }
   ...
   public void registerTypes(Schema schema, Map var2, Map var3) {
      ...
      schema.registerType(true, References.ITEM_STACK, () -> {
         return DSL.hook(DSL.optionalFields("id", References.ITEM_NAME.in(schema), "tag", DSL.optionalFields("EntityTag", References.ENTITY_TREE.in(schema), "BlockEntityTag", References.BLOCK_ENTITY.in(schema), "CanDestroy", DSL.list(References.BLOCK_NAME.in(schema)), "CanPlaceOn", DSL.list(References.BLOCK_NAME.in(schema)))), V705.ADD_NAMES, HookFunction.IDENTITY);
      });
