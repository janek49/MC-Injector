...
public class ItemIdFix extends DataFix {
   private static final Int2ObjectMap ITEM_NAMES = (Int2ObjectMap)DataFixUtils.make(new Int2ObjectOpenHashMap(), (int2ObjectOpenHashMap) -> {
   ...
   public ItemIdFix(Schema schema, boolean var2) {
      super(schema, var2);
   }

   public static String getItem(int i) {
      return (String)ITEM_NAMES.get(i);
   }

   public TypeRewriteRule makeRule() {
      Type<Either<Integer, Pair<String, String>>> var1 = DSL.or(DSL.intType(), DSL.named(References.ITEM_NAME.typeName(), DSL.namespacedString()));
      Type<Pair<String, String>> var2 = DSL.named(References.ITEM_NAME.typeName(), DSL.namespacedString());
      OpticFinder<Either<Integer, Pair<String, String>>> var3 = DSL.fieldFinder("id", var1);
      return this.fixTypeEverywhereTyped("ItemIdFix", this.getInputSchema().getType(References.ITEM_STACK), this.getOutputSchema().getType(References.ITEM_STACK), (var2x) -> {
         return var2x.update(var3, var2, (either) -> {
            return (Pair)either.map((integer) -> {
               return Pair.of(References.ITEM_NAME.typeName(), getItem(integer.intValue()));
            }, (pair) -> {
               return pair;
            });
         });
