...
public class RealmsClickableScrolledSelectionListProxy extends ScrolledSelectionList {
   ...
   public RealmsClickableScrolledSelectionListProxy(RealmsClickableScrolledSelectionList realmsClickableScrolledSelectionList, int var2, int var3, int var4, int var5, int var6) {
   ...
   public void renderSelected(int var1, int var2, int var3, Tezzelator tezzelator) {
      this.realmsClickableScrolledSelectionList.renderSelected(var1, var2, var3, tezzelator);
   }
