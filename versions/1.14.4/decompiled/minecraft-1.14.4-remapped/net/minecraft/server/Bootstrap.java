...
public class Bootstrap {
   ...
   private static void checkTranslations(Registry registry, Function function, Set set) {
      Language var3 = Language.getInstance();
      registry.iterator().forEachRemaining((object) -> {
         String var4 = (String)function.apply(object);
         if(!var3.exists(var4)) {
            set.add(var4);
         }
   ...
   public static Set getMissingTranslations() {
      ...
      checkTranslations(Registry.CUSTOM_STAT, (resourceLocation) -> {
   ...
   public static void validate() {
      if(!isBootstrapped) {
         ...
         getMissingTranslations().forEach((string) -> {
