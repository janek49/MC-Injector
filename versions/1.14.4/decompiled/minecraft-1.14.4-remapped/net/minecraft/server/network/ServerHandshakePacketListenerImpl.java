   ...
   public void handleIntention(ClientIntentionPacket clientIntentionPacket) {
      ...
      case LOGIN:
         ...
         if(clientIntentionPacket.getProtocolVersion() > SharedConstants.getCurrentVersion().getProtocolVersion()) {
            Component var2 = new TranslatableComponent("multiplayer.disconnect.outdated_server", new Object[]{SharedConstants.getCurrentVersion().getName()});
            ...
            Component var2 = new TranslatableComponent("multiplayer.disconnect.outdated_client", new Object[]{SharedConstants.getCurrentVersion().getName()});
            this.connection.send(new ClientboundLoginDisconnectPacket(var2));
            this.connection.disconnect(var2);
         } else {
