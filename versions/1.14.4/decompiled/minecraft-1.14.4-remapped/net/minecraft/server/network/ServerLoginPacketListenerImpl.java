...
public class ServerLoginPacketListenerImpl implements ServerLoginPacketListener {
   ...
   public void handleKey(ServerboundKeyPacket serverboundKeyPacket) {
      ...
      if(!Arrays.equals(this.nonce, serverboundKeyPacket.getNonce(var2))) {
         throw new IllegalStateException("Invalid nonce!");
      } else {
         this.secretKey = serverboundKeyPacket.getSecretKey(var2);
   ...
   protected GameProfile createFakeProfile(GameProfile gameProfile) {
      UUID var2 = Player.createPlayerUUID(gameProfile.getName());
      return new GameProfile(var2, gameProfile.getName());
   }
