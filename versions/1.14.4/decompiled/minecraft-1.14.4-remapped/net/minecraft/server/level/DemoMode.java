...
public class DemoMode extends ServerPlayerGameMode {
   ...
   public void handleBlockBreakAction(BlockPos blockPos, ServerboundPlayerActionPacket.Action serverboundPlayerActionPacket$Action, Direction direction, int var4) {
      if(this.demoHasEnded) {
         this.outputDemoReminder();
      } else {
         super.handleBlockBreakAction(blockPos, serverboundPlayerActionPacket$Action, direction, var4);
      }
   }
