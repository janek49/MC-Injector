...
public class RconThread extends GenericThread {
   ...
   public RconThread(ServerInterface serverInterface) {
      ...
      DedicatedServerProperties var2 = serverInterface.getProperties();
   ...
   private void clearClients() {
      Iterator<Entry<SocketAddress, RconClient>> var1 = this.clients.entrySet().iterator();

      while(var1.hasNext()) {
         Entry<SocketAddress, RconClient> var2 = (Entry)var1.next();
   ...
   public void stop() {
      ...
      for(Entry<SocketAddress, RconClient> var2 : this.clients.entrySet()) {
