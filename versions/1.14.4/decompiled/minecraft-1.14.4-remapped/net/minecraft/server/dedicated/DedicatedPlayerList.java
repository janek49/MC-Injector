...
public class DedicatedPlayerList extends PlayerList {
   ...
   public DedicatedPlayerList(DedicatedServer dedicatedServer) {
      ...
      DedicatedServerProperties var2 = dedicatedServer.getProperties();
      this.setViewDistance(var2.viewDistance);
      super.setUsingWhiteList(((Boolean)var2.whiteList.get()).booleanValue());
   ...
   public void setUsingWhiteList(boolean usingWhiteList) {
      super.setUsingWhiteList(usingWhiteList);
      this.getServer().storeUsingWhiteList(usingWhiteList);
   }
