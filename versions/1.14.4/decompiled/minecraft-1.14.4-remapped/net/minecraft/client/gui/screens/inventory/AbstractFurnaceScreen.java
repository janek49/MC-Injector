...
public abstract class AbstractFurnaceScreen extends AbstractContainerScreen implements RecipeUpdateListener {
   ...
   public AbstractFurnaceScreen(AbstractFurnaceMenu abstractFurnaceMenu, AbstractFurnaceRecipeBookComponent recipeBookComponent, Inventory inventory, Component component, ResourceLocation texture) {
   ...
   protected void renderBg(float var1, int var2, int var3) {
      ...
      if(((AbstractFurnaceMenu)this.menu).isLit()) {
         int var6 = ((AbstractFurnaceMenu)this.menu).getLitProgress();
         this.blit(var4 + 56, var5 + 36 + 12 - var6, 176, 12 - var6, 14, var6 + 1);
      }

      int var6 = ((AbstractFurnaceMenu)this.menu).getBurnProgress();
      this.blit(var4 + 79, var5 + 34, 176, 14, var6 + 1, 16);
   }

   public boolean mouseClicked(double var1, double var3, int var5) {
      return this.recipeBookComponent.mouseClicked(var1, var3, var5)?true:(this.widthTooNarrow && this.recipeBookComponent.isVisible()?true:super.mouseClicked(var1, var3, var5));
   }
