...
public class SignEditScreen extends Screen {
   ...
   protected void init() {
      ...
      this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 120, 200, 20, I18n.get("gui.done", new Object[0]), (button) -> {
         this.onDone();
      }));
   ...
   public void render(int var1, int var2, float var3) {
      ...
      if(var5.getBlock() instanceof StandingSignBlock) {
         var6 = (float)(((Integer)var5.getValue(StandingSignBlock.ROTATION)).intValue() * 360) / 16.0F;
      } else {
