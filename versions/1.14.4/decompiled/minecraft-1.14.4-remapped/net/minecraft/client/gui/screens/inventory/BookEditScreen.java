...
public class BookEditScreen extends Screen {
   ...
   protected void init() {
      ...
      this.signButton = (Button)this.addButton(new Button(this.width / 2 - 100, 196, 98, 20, I18n.get("book.signButton", new Object[0]), (button) -> {
         this.isSigning = true;
         this.updateButtonVisibility();
      }));
      this.doneButton = (Button)this.addButton(new Button(this.width / 2 + 2, 196, 98, 20, I18n.get("gui.done", new Object[0]), (button) -> {
         this.minecraft.setScreen((Screen)null);
         this.saveChanges(false);
      }));
      this.finalizeButton = (Button)this.addButton(new Button(this.width / 2 - 100, 196, 98, 20, I18n.get("book.finalizeButton", new Object[0]), (button) -> {
         if(this.isSigning) {
      ...
      this.cancelButton = (Button)this.addButton(new Button(this.width / 2 + 2, 196, 98, 20, I18n.get("gui.cancel", new Object[0]), (button) -> {
         if(this.isSigning) {
      ...
      int var2 = 2;
      this.forwardButton = (PageButton)this.addButton(new PageButton(var1 + 116, 159, true, (button) -> {
         this.pageForward();
      }, true));
      this.backButton = (PageButton)this.addButton(new PageButton(var1 + 43, 159, false, (button) -> {
         this.pageBack();
      }, true));
      this.updateButtonVisibility();
   }
   ...
   private void eraseEmptyTrailingPages() {
      ListIterator<String> var1 = this.pages.listIterator(this.pages.size());
   ...
   private void saveChanges(boolean b) {
      if(this.isModified) {
         this.eraseEmptyTrailingPages();
         ListTag var2 = new ListTag();
         this.pages.stream().map(StringTag::<init>).forEach(var2::add);
         if(!this.pages.isEmpty()) {
         ...
         this.minecraft.getConnection().send((Packet)(new ServerboundEditBookPacket(this.book, b, this.hand)));
      }
   }
   ...
   public boolean keyPressed(int var1, int var2, int var3) {
      return super.keyPressed(var1, var2, var3)?true:(this.isSigning?this.titleKeyPressed(var1, var2, var3):this.bookKeyPressed(var1, var2, var3));
   }
   ...
   private void keyBackspace(String string) {
      if(!string.isEmpty()) {
         if(this.selectionPos != this.cursorPos) {
            ...
            String string = (new StringBuilder(string)).deleteCharAt(Math.max(0, this.cursorPos - 1)).toString();
            this.setCurrentPageText(string);
   ...
   private void keyDelete(String string) {
      if(!string.isEmpty()) {
         if(this.selectionPos != this.cursorPos) {
            ...
            String string = (new StringBuilder(string)).deleteCharAt(Math.max(0, this.cursorPos)).toString();
            this.setCurrentPageText(string);
         }
      }
   ...
   private void keyLeft(String string) {
      ...
      if(Screen.hasControlDown()) {
         this.cursorPos = this.font.getWordPosition(string, var2, this.cursorPos, true);
      } else {
   ...
   private void keyRight(String string) {
      ...
      if(Screen.hasControlDown()) {
         ...
         this.cursorPos = Math.min(string.length(), this.cursorPos + var2);
      }
   ...
   private void keyUp(String string) {
      if(!string.isEmpty()) {
         BookEditScreen.Pos2i var2 = this.getPositionAtIndex(string, this.cursorPos);
         if(var2.y == 0) {
            this.cursorPos = 0;
            if(!Screen.hasShiftDown()) {
               this.selectionPos = this.cursorPos;
            ...
            int var10005 = var2.x + this.getWidthAt(string, this.cursorPos) / 3;
            int var10006 = var2.y;
            this.font.getClass();
            int var3 = this.getIndexAtPosition(string, new BookEditScreen.Pos2i(var10005, var10006 - 9));
            if(var3 >= 0) {
               this.cursorPos = var3;
               if(!Screen.hasShiftDown()) {
                  this.selectionPos = this.cursorPos;
   ...
   private void keyDown(String string) {
      if(!string.isEmpty()) {
         BookEditScreen.Pos2i var2 = this.getPositionAtIndex(string, this.cursorPos);
         int var3 = this.font.wordWrapHeight(string + "" + ChatFormatting.BLACK + "_", 114);
         int var10000 = var2.y;
         this.font.getClass();
         if(var10000 + 9 == var3) {
            ...
            int var10006 = var2.y;
            this.font.getClass();
            int var4 = this.getIndexAtPosition(string, new BookEditScreen.Pos2i(var10005, var10006 + 9));
            if(var4 >= 0) {
               this.cursorPos = var4;
               if(!Screen.hasShiftDown()) {
                  this.selectionPos = this.cursorPos;
   ...
   private int getWidthAt(String string, int var2) {
      return (int)this.font.charWidth(string.charAt(Mth.clamp(var2, 0, string.length() - 1)));
   }
   ...
   private void setCurrentPageText(String currentPageText) {
   ...
   public void render(int var1, int var2, float var3) {
      ...
      if(this.isSigning) {
         ...
         String var7 = I18n.get("book.editTitle", new Object[0]);
         int var8 = this.strWidth(var7);
         ...
         String var10 = I18n.get("book.byAuthor", new Object[]{this.owner.getName().getString()});
         int var11 = this.strWidth(var10);
         this.font.draw(ChatFormatting.DARK_GRAY + var10, (float)(var4 + 36 + (114 - var11) / 2), 60.0F, 0);
         String var12 = I18n.get("book.finalizeWarning", new Object[0]);
         this.font.drawWordWrap(var12, var4 + 36, 82, 114, 0);
      } else {
         String var6 = I18n.get("book.pageIndicator", new Object[]{Integer.valueOf(this.currentPage + 1), Integer.valueOf(this.getNumPages())});
         String var7 = this.getCurrentPageText();
         int var8 = this.strWidth(var6);
         this.font.draw(var6, (float)(var4 - var8 + 192 - 44), 18.0F, 0);
         this.font.drawWordWrap(var7, var4 + 36, 32, 114, 0);
         this.renderSelection(var7);
         if(this.frameTick / 6 % 2 == 0) {
            BookEditScreen.Pos2i var9 = this.getPositionAtIndex(var7, this.cursorPos);
            if(this.font.isBidirectional()) {
               this.handleBidi(var9);
               var9.x = var9.x - 4;
            }

            this.convertLocalToScreen(var9);
            if(this.cursorPos < var7.length()) {
               int var10000 = var9.x;
               int var10001 = var9.y - 1;
               int var10002 = var9.x + 1;
               int var10003 = var9.y;
               this.font.getClass();
               GuiComponent.fill(var10000, var10001, var10002, var10003 + 9, -16777216);
            } else {
               this.font.draw("_", (float)var9.x, (float)var9.y, 0);
            }
         }
      }
   ...
   private int strIndexAtWidth(String string, int var2) {
      return this.font.indexAtWidth(string, var2);
   }
   ...
   private void renderSelection(String string) {
      if(this.selectionPos != this.cursorPos) {
         int var2 = Math.min(this.cursorPos, this.selectionPos);
         int var3 = Math.max(this.cursorPos, this.selectionPos);
         String var4 = string.substring(var2, var3);
         int var5 = this.font.getWordPosition(string, 1, var3, true);
         String var6 = string.substring(var2, var5);
         BookEditScreen.Pos2i var7 = this.getPositionAtIndex(string, var2);
         int var10003 = var7.x;
         int var10004 = var7.y;
         this.font.getClass();
         ...
         while(!var4.isEmpty()) {
            ...
            boolean var12 = var11 == 32 || var11 == 10;
   ...
   private BookEditScreen.Pos2i getPositionAtIndex(String string, int var2) {
      BookEditScreen.Pos2i bookEditScreen$Pos2i = new BookEditScreen.Pos2i();
      int var4 = 0;
      int var5 = 0;

      for(String var6 = string; !var6.isEmpty(); var5 = var4) {
         int var7 = this.strIndexAtWidth(var6, 114);
         if(var6.length() <= var7) {
            String var8 = var6.substring(0, Math.min(Math.max(var2 - var5, 0), var6.length()));
            bookEditScreen$Pos2i.x = bookEditScreen$Pos2i.x + this.strWidth(var8);
            break;
         }

         String var8 = var6.substring(0, var7);
         char var9 = var6.charAt(var7);
         boolean var10 = var9 == 32 || var9 == 10;
         ...
         if(var4 - 1 >= var2) {
            ...
            bookEditScreen$Pos2i.x = bookEditScreen$Pos2i.x + this.strWidth(var11);
            break;
         }

         int var10001 = bookEditScreen$Pos2i.y;
         this.font.getClass();
         bookEditScreen$Pos2i.y = var10001 + 9;
      }

      return bookEditScreen$Pos2i;
   }

   private void handleBidi(BookEditScreen.Pos2i bookEditScreen$Pos2i) {
      if(this.font.isBidirectional()) {
         bookEditScreen$Pos2i.x = 114 - bookEditScreen$Pos2i.x;
      }

   }

   private void convertScreenToLocal(BookEditScreen.Pos2i bookEditScreen$Pos2i) {
      bookEditScreen$Pos2i.x = bookEditScreen$Pos2i.x - (this.width - 192) / 2 - 36;
      bookEditScreen$Pos2i.y = bookEditScreen$Pos2i.y - 32;
   }

   private void convertLocalToScreen(BookEditScreen.Pos2i bookEditScreen$Pos2i) {
      bookEditScreen$Pos2i.x = bookEditScreen$Pos2i.x + (this.width - 192) / 2 + 36;
      bookEditScreen$Pos2i.y = bookEditScreen$Pos2i.y + 32;
   }

   private int indexInLine(String string, int var2) {
      if(var2 < 0) {
         return 0;
      } else {
         float var4 = 0.0F;
   ...
   private int getIndexAtPosition(String string, BookEditScreen.Pos2i bookEditScreen$Pos2i) {
      this.font.getClass();
      int var3 = 16 * 9;
      if(bookEditScreen$Pos2i.y > var3) {
         return -1;
      } else {
         ...
         for(String var7 = string; !var7.isEmpty() && var4 < var3; var5 += 9) {
            int var8 = this.strIndexAtWidth(var7, 114);
            if(var8 < var7.length()) {
               String var9 = var7.substring(0, var8);
               if(bookEditScreen$Pos2i.y >= var4 && bookEditScreen$Pos2i.y < var5) {
                  int var10 = this.indexInLine(var9, bookEditScreen$Pos2i.x);
                  return var10 < 0?-1:var6 + var10;
               }

               char var10 = var7.charAt(var8);
               boolean var11 = var10 == 32 || var10 == 10;
               var7 = ChatFormatting.getLastColors(var9) + var7.substring(var8 + (var11?1:0));
               var6 += var9.length() + (var11?1:0);
            } else if(bookEditScreen$Pos2i.y >= var4 && bookEditScreen$Pos2i.y < var5) {
               int var9 = this.indexInLine(var7, bookEditScreen$Pos2i.x);
               return var9 < 0?-1:var6 + var9;
            }
