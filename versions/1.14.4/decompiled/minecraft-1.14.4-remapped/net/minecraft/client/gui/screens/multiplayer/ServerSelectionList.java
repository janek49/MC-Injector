...
public class ServerSelectionList extends ObjectSelectionList {
   ...
   public ServerSelectionList(JoinMultiplayerScreen screen, Minecraft minecraft, int var3, int var4, int var5, int var6, int var7) {
   ...
   protected void moveSelection(int i) {
      ...
      if(var4 instanceof ServerSelectionList.LANHeader) {
         if(i <= 0 || var3 != this.getItemCount() - 1) {
            if(i >= 0 || var3 != 0) {
   ...
   public void updateOnlineServers(ServerList serverList) {
      ...
      for(int var2 = 0; var2 < serverList.size(); ++var2) {
         this.onlineServers.add(new ServerSelectionList.OnlineServerEntry(this.screen, serverList.get(var2)));
      }

      this.refreshEntries();
   }

   public void updateNetworkServers(List list) {
      this.networkServers.clear();

      for(LanServer var3 : list) {
   ...
   public static class LANHeader extends ServerSelectionList.Entry {
      ...
      public void render(int var1, int var2, int var3, int var4, int var5, int var6, int var7, boolean var8, float var9) {
         ...
         this.minecraft.font.draw(I18n.get("lanServer.scanning", new Object[0]), (float)(this.minecraft.screen.width / 2 - this.minecraft.font.width(I18n.get("lanServer.scanning", new Object[0])) / 2), (float)var10, 16777215);
         String var11;
   ...
   public static class NetworkServerEntry extends ServerSelectionList.Entry {
      ...
      public void render(int var1, int var2, int var3, int var4, int var5, int var6, int var7, boolean var8, float var9) {
         this.minecraft.font.draw(I18n.get("lanServer.title", new Object[0]), (float)(var3 + 32 + 3), (float)(var2 + 1), 16777215);
         this.minecraft.font.draw(this.serverData.getMotd(), (float)(var3 + 32 + 3), (float)(var2 + 12), 8421504);
         if(this.minecraft.options.hideServerAddress) {
            this.minecraft.font.draw(I18n.get("selectServer.hiddenAddress", new Object[0]), (float)(var3 + 32 + 3), (float)(var2 + 12 + 11), 3158064);
         } else {
   ...
   public class OnlineServerEntry extends ServerSelectionList.Entry {
      ...
      public void render(int var1, int var2, int var3, int var4, int var5, int var6, int var7, boolean var8, float var9) {
         if(!this.serverData.pinged) {
            ...
            ServerSelectionList.THREAD_POOL.submit(() -> {
               try {
                  ...
                  this.serverData.motd = ChatFormatting.DARK_RED + I18n.get("multiplayer.status.cannot_resolve", new Object[0]);
               } catch (Exception var3) {
                  this.serverData.ping = -1L;
                  this.serverData.motd = ChatFormatting.DARK_RED + I18n.get("multiplayer.status.cannot_connect", new Object[0]);
               }
         ...
         List<String> var13 = this.minecraft.font.split(this.serverData.motd, var4 - 32 - 2);
         ...
         String var14 = var12?ChatFormatting.DARK_RED + this.serverData.version:this.serverData.status;
         int var15 = this.minecraft.font.width(var14);
         this.minecraft.font.draw(var14, (float)(var3 + var4 - var15 - 15 - 2), (float)(var2 + 1), 8421504);
         int var16 = 0;
         String var18 = null;
         int var17;
         String var19;
         if(var12) {
            var17 = 5;
            var19 = I18n.get(var10?"multiplayer.status.client_out_of_date":"multiplayer.status.server_out_of_date", new Object[0]);
            ...
            if(this.serverData.ping < 0L) {
               var19 = I18n.get("multiplayer.status.no_connection", new Object[0]);
            } else {
            ...
            var19 = I18n.get("multiplayer.status.pinging", new Object[0]);
         }
      ...
      protected void drawIcon(int var1, int var2, ResourceLocation resourceLocation) {
      ...
      public boolean mouseClicked(double var1, double var3, int var5) {
         ...
         if(var6 <= 32.0D) {
            ...
            if(var6 < 16.0D && var8 < 16.0D && var10 > 0) {
               int var11 = Screen.hasShiftDown()?0:var10 - 1;
               this.screen.getServers().swap(var10, var11);
