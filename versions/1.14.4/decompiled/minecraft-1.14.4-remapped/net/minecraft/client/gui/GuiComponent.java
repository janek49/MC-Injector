...
public abstract class GuiComponent {
   ...
   public static void fill(int var0, int var1, int var2, int var3, int var4) {
      ...
      GlStateManager.color4f(var6, var7, var8, var5);
   ...
   public void drawCenteredString(Font font, String string, int var3, int var4, int var5) {
      font.drawShadow(string, (float)(var3 - font.width(string) / 2), (float)var4, var5);
   }

   public void drawRightAlignedString(Font font, String string, int var3, int var4, int var5) {
      font.drawShadow(string, (float)(var3 - font.width(string)), (float)var4, var5);
   }

   public void drawString(Font font, String string, int var3, int var4, int var5) {
      font.drawShadow(string, (float)var3, (float)var4, var5);
   }

   public static void blit(int var0, int var1, int var2, int var3, int var4, TextureAtlasSprite textureAtlasSprite) {
      innerBlit(var0, var0 + var3, var1, var1 + var4, var2, textureAtlasSprite.getU0(), textureAtlasSprite.getU1(), textureAtlasSprite.getV0(), textureAtlasSprite.getV1());
   }
