...
public class LoadingOverlay extends Overlay {
   ...
   public LoadingOverlay(Minecraft minecraft, ReloadInstance reload, Runnable onFinish, boolean fadeIn) {
   ...
   public static void registerTextures(Minecraft minecraft) {
      minecraft.getTextureManager().register((ResourceLocation)MOJANG_LOGO_LOCATION, (TextureObject)(new LoadingOverlay.LogoTexture()));
   }
   ...
   public void render(int var1, int var2, float var3) {
      ...
      if(var8 >= 1.0F) {
         ...
         int var11 = Mth.ceil((1.0F - Mth.clamp(var8 - 1.0F, 0.0F, 1.0F)) * 255.0F);
         ...
         int var11 = Mth.ceil(Mth.clamp((double)var9, 0.15D, 1.0D) * 255.0D);
         fill(0, 0, var4, var5, 16777215 | var11 << 24);
      ...
      int var11 = (this.minecraft.window.getGuiScaledWidth() - 256) / 2;
