...
public class StructureBlockEditScreen extends Screen {
   ...
   protected void init() {
      ...
      this.cancelButton = (Button)this.addButton(new Button(this.width / 2 + 4, 210, 150, 20, I18n.get("gui.cancel", new Object[0]), (button) -> {
         this.onCancel();
      }));
      this.saveButton = (Button)this.addButton(new Button(this.width / 2 + 4 + 100, 185, 50, 20, I18n.get("structure_block.button.save", new Object[0]), (button) -> {
      ...
      this.loadButton = (Button)this.addButton(new Button(this.width / 2 + 4 + 100, 185, 50, 20, I18n.get("structure_block.button.load", new Object[0]), (button) -> {
      ...
      this.modeButton = (Button)this.addButton(new Button(this.width / 2 - 4 - 150, 185, 50, 20, "MODE", (button) -> {
         this.structure.nextMode();
         this.updateMode();
      }));
      this.detectButton = (Button)this.addButton(new Button(this.width / 2 + 4 + 100, 120, 50, 20, I18n.get("structure_block.button.detect_size", new Object[0]), (button) -> {
         if(this.structure.getMode() == StructureMode.SAVE) {
      ...
      this.entitiesButton = (Button)this.addButton(new Button(this.width / 2 + 4 + 100, 160, 50, 20, "ENTITIES", (button) -> {
         this.structure.setIgnoreEntities(!this.structure.isIgnoreEntities());
         this.updateEntitiesButton();
      }));
      this.mirrorButton = (Button)this.addButton(new Button(this.width / 2 - 20, 185, 40, 20, "MIRROR", (button) -> {
      ...
      this.toggleAirButton = (Button)this.addButton(new Button(this.width / 2 + 4 + 100, 80, 50, 20, "SHOWAIR", (button) -> {
         this.structure.setShowAir(!this.structure.getShowAir());
         this.updateToggleAirButton();
      }));
      this.toggleBoundingBox = (Button)this.addButton(new Button(this.width / 2 + 4 + 100, 80, 50, 20, "SHOWBB", (button) -> {
         this.structure.setShowBoundingBox(!this.structure.getShowBoundingBox());
         this.updateToggleBoundingBox();
      }));
      this.rot0Button = (Button)this.addButton(new Button(this.width / 2 - 1 - 40 - 1 - 40 - 20, 185, 40, 20, "0", (button) -> {
         this.structure.setRotation(Rotation.NONE);
         this.updateDirectionButtons();
      }));
      this.rot90Button = (Button)this.addButton(new Button(this.width / 2 - 1 - 40 - 20, 185, 40, 20, "90", (button) -> {
         this.structure.setRotation(Rotation.CLOCKWISE_90);
         this.updateDirectionButtons();
      }));
      this.rot180Button = (Button)this.addButton(new Button(this.width / 2 + 1 + 20, 185, 40, 20, "180", (button) -> {
         this.structure.setRotation(Rotation.CLOCKWISE_180);
         this.updateDirectionButtons();
      }));
      this.rot270Button = (Button)this.addButton(new Button(this.width / 2 + 1 + 40 + 1 + 20, 185, 40, 20, "270", (button) -> {
         this.structure.setRotation(Rotation.COUNTERCLOCKWISE_90);
         this.updateDirectionButtons();
      }));
      this.nameEdit = new EditBox(this.font, this.width / 2 - 152, 40, 300, 20, I18n.get("structure_block.structure_name", new Object[0])) {
      ...
      this.posXEdit = new EditBox(this.font, this.width / 2 - 152, 80, 80, 20, I18n.get("structure_block.position.x", new Object[0]));
      this.posXEdit.setMaxLength(15);
      this.posXEdit.setValue(Integer.toString(var1.getX()));
      this.children.add(this.posXEdit);
      this.posYEdit = new EditBox(this.font, this.width / 2 - 72, 80, 80, 20, I18n.get("structure_block.position.y", new Object[0]));
      this.posYEdit.setMaxLength(15);
      this.posYEdit.setValue(Integer.toString(var1.getY()));
      this.children.add(this.posYEdit);
      this.posZEdit = new EditBox(this.font, this.width / 2 + 8, 80, 80, 20, I18n.get("structure_block.position.z", new Object[0]));
      ...
      this.sizeXEdit = new EditBox(this.font, this.width / 2 - 152, 120, 80, 20, I18n.get("structure_block.size.x", new Object[0]));
      this.sizeXEdit.setMaxLength(15);
      this.sizeXEdit.setValue(Integer.toString(var2.getX()));
      this.children.add(this.sizeXEdit);
      this.sizeYEdit = new EditBox(this.font, this.width / 2 - 72, 120, 80, 20, I18n.get("structure_block.size.y", new Object[0]));
      this.sizeYEdit.setMaxLength(15);
      this.sizeYEdit.setValue(Integer.toString(var2.getY()));
      this.children.add(this.sizeYEdit);
      this.sizeZEdit = new EditBox(this.font, this.width / 2 + 8, 120, 80, 20, I18n.get("structure_block.size.z", new Object[0]));
      this.sizeZEdit.setMaxLength(15);
      this.sizeZEdit.setValue(Integer.toString(var2.getZ()));
      this.children.add(this.sizeZEdit);
      this.integrityEdit = new EditBox(this.font, this.width / 2 - 152, 120, 80, 20, I18n.get("structure_block.integrity.integrity", new Object[0]));
      ...
      this.seedEdit = new EditBox(this.font, this.width / 2 - 72, 120, 80, 20, I18n.get("structure_block.integrity.seed", new Object[0]));
      this.seedEdit.setMaxLength(31);
      this.seedEdit.setValue(Long.toString(this.structure.getSeed()));
      this.children.add(this.seedEdit);
      this.dataEdit = new EditBox(this.font, this.width / 2 - 152, 120, 240, 20, I18n.get("structure_block.custom_data", new Object[0]));
   ...
   private void updateEntitiesButton() {
      ...
      if(var1) {
         this.entitiesButton.setMessage(I18n.get("options.on", new Object[0]));
      } else {
         this.entitiesButton.setMessage(I18n.get("options.off", new Object[0]));
      }
   ...
   private void updateToggleAirButton() {
      ...
      if(var1) {
         this.toggleAirButton.setMessage(I18n.get("options.on", new Object[0]));
      } else {
         this.toggleAirButton.setMessage(I18n.get("options.off", new Object[0]));
      }
   ...
   private void updateToggleBoundingBox() {
      ...
      if(var1) {
         this.toggleBoundingBox.setMessage(I18n.get("options.on", new Object[0]));
      } else {
         this.toggleBoundingBox.setMessage(I18n.get("options.off", new Object[0]));
      }
   ...
   private void updateMode() {
      ...
      this.modeButton.setMessage(I18n.get("structure_block.mode." + this.structure.getMode().getSerializedName(), new Object[0]));
   }

   private boolean sendToServer(StructureBlockEntity.UpdateType structureBlockEntity$UpdateType) {
   ...
   public void render(int var1, int var2, float var3) {
      ...
      if(var4 != StructureMode.DATA) {
         this.drawString(this.font, I18n.get("structure_block.structure_name", new Object[0]), this.width / 2 - 153, 30, 10526880);
         this.nameEdit.render(var1, var2, var3);
      }

      if(var4 == StructureMode.LOAD || var4 == StructureMode.SAVE) {
         this.drawString(this.font, I18n.get("structure_block.position", new Object[0]), this.width / 2 - 153, 70, 10526880);
         this.posXEdit.render(var1, var2, var3);
         this.posYEdit.render(var1, var2, var3);
         this.posZEdit.render(var1, var2, var3);
         String var5 = I18n.get("structure_block.include_entities", new Object[0]);
         int var6 = this.font.width(var5);
         this.drawString(this.font, var5, this.width / 2 + 154 - var6, 150, 10526880);
      }

      if(var4 == StructureMode.SAVE) {
         this.drawString(this.font, I18n.get("structure_block.size", new Object[0]), this.width / 2 - 153, 110, 10526880);
         this.sizeXEdit.render(var1, var2, var3);
         this.sizeYEdit.render(var1, var2, var3);
         this.sizeZEdit.render(var1, var2, var3);
         String var5 = I18n.get("structure_block.detect_size", new Object[0]);
         int var6 = this.font.width(var5);
         this.drawString(this.font, var5, this.width / 2 + 154 - var6, 110, 10526880);
         String var7 = I18n.get("structure_block.show_air", new Object[0]);
         int var8 = this.font.width(var7);
         this.drawString(this.font, var7, this.width / 2 + 154 - var8, 70, 10526880);
      }

      if(var4 == StructureMode.LOAD) {
         this.drawString(this.font, I18n.get("structure_block.integrity", new Object[0]), this.width / 2 - 153, 110, 10526880);
         this.integrityEdit.render(var1, var2, var3);
         this.seedEdit.render(var1, var2, var3);
         String var5 = I18n.get("structure_block.show_boundingbox", new Object[0]);
         int var6 = this.font.width(var5);
         this.drawString(this.font, var5, this.width / 2 + 154 - var6, 70, 10526880);
      }

      if(var4 == StructureMode.DATA) {
         this.drawString(this.font, I18n.get("structure_block.custom_data", new Object[0]), this.width / 2 - 153, 110, 10526880);
         this.dataEdit.render(var1, var2, var3);
      }

      String var5 = "structure_block.mode_info." + var4.getSerializedName();
      this.drawString(this.font, I18n.get(var5, new Object[0]), this.width / 2 - 153, 174, 10526880);
