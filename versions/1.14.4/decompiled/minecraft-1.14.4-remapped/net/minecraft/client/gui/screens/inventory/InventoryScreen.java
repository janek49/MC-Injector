...
public class InventoryScreen extends EffectRenderingInventoryScreen implements RecipeUpdateListener {
   ...
   public static void renderPlayerModel(int var0, int var1, int var2, float var3, float var4, LivingEntity livingEntity) {
      ...
      livingEntity.yBodyRot = (float)Math.atan((double)(var3 / 40.0F)) * 20.0F;
      livingEntity.yRot = (float)Math.atan((double)(var3 / 40.0F)) * 40.0F;
      livingEntity.xRot = -((float)Math.atan((double)(var4 / 40.0F))) * 20.0F;
      ...
      var11.render(livingEntity, 0.0D, 0.0D, 0.0D, 0.0F, 1.0F, false);
   ...
   public boolean mouseClicked(double var1, double var3, int var5) {
      return this.recipeBookComponent.mouseClicked(var1, var3, var5)?true:(this.widthTooNarrow && this.recipeBookComponent.isVisible()?false:super.mouseClicked(var1, var3, var5));
   }
