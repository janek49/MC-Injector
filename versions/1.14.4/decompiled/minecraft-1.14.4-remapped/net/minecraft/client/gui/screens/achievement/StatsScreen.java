...
public class StatsScreen extends Screen implements StatsUpdateListener {
   ...
   public void initButtons() {
      this.addButton(new Button(this.width / 2 - 120, this.height - 52, 80, 20, I18n.get("stat.generalButton", new Object[0]), (button) -> {
         this.setActiveList(this.statsList);
      }));
      Button var1 = (Button)this.addButton(new Button(this.width / 2 - 40, this.height - 52, 80, 20, I18n.get("stat.itemsButton", new Object[0]), (button) -> {
         this.setActiveList(this.itemStatsList);
      }));
      Button var2 = (Button)this.addButton(new Button(this.width / 2 + 40, this.height - 52, 80, 20, I18n.get("stat.mobsButton", new Object[0]), (button) -> {
         this.setActiveList(this.mobsStatsList);
      }));
      this.addButton(new Button(this.width / 2 - 100, this.height - 28, 200, 20, I18n.get("gui.done", new Object[0]), (button) -> {
   ...
   public void render(int var1, int var2, float var3) {
      if(this.isLoading) {
         ...
         this.drawCenteredString(this.font, I18n.get("multiplayer.downloadingStats", new Object[0]), this.width / 2, this.height / 2, 16777215);
   ...
   public void setActiveList(@Nullable ObjectSelectionList activeList) {
      ...
      if(activeList != null) {
         this.children.add(0, activeList);
   ...
   private void blitSlot(int var1, int var2, Item item) {
      ...
      Lighting.turnOnGui();
      this.itemRenderer.renderGuiItem(item.getDefaultInstance(), var1 + 2, var2 + 2);
      Lighting.turnOff();
   ...
   class GeneralStatisticsList extends ObjectSelectionList {
      public GeneralStatisticsList(Minecraft minecraft) {
         ...
         for(Stat<ResourceLocation> var4 : Stats.CUSTOM) {
   ...
   class ItemStatisticsList extends ObjectSelectionList {
      ...
      public ItemStatisticsList(Minecraft minecraft) {
         ...
         for(Block var5 : Registry.BLOCK) {
            ...
            for(StatType<Block> var8 : this.blockColumns) {
               if(var8.contains(var5) && StatsScreen.this.stats.getValue(var8.get(var5)) > 0) {
                  var6 = true;
               }
            }
         ...
         for(int var4 = 0; var4 < this.statItemList.size(); ++var4) {
      ...
      protected void renderHeader(int var1, int var2, Tesselator tesselator) {
         ...
         if(this.sortColumn != null) {
            int var4 = StatsScreen.this.getColumnX(this.getColumnIndex(this.sortColumn)) - 36;
      ...
      private int getColumnIndex(StatType statType) {
         int var2 = this.blockColumns.indexOf(statType);
         if(var2 >= 0) {
            return var2;
         } else {
            int var3 = this.itemColumns.indexOf(statType);
      ...
      protected void renderDecorations(int var1, int var2) {
         if(var2 >= this.y0 && var2 <= this.y1) {
            ...
            if(var3 != null) {
               ...
               Item var5 = (Item)this.statItemList.get(this.children().indexOf(var3));
               this.renderMousehoverTooltip(this.getString(var5), var1, var2);
            } else {
               Component var5 = null;
               int var6 = var1 - var4;
      ...
      protected void renderMousehoverTooltip(@Nullable Component component, int var2, int var3) {
         if(component != null) {
            String var4 = component.getColoredString();
            int var5 = var2 + 12;
            int var6 = var3 - 12;
      ...
      protected void sortByColumn(StatType sortColumn) {
      ...
      class ItemComparator implements Comparator {
         ...
         public int compare(Item var1, Item var2) {
            ...
            if(ItemStatisticsList.this.sortColumn == null) {
               ...
               StatType<Block> var5 = ItemStatisticsList.this.sortColumn;
      ...
      class ItemRow extends ObjectSelectionList.Entry {
         ...
         public void render(int var1, int var2, int var3, int var4, int var5, int var6, int var7, boolean var8, float var9) {
            ...
            for(int var11 = 0; var11 < StatsScreen.this.itemStatsList.itemColumns.size(); ++var11) {
         ...
         protected void renderStat(@Nullable Stat stat, int var2, int var3, boolean var4) {
            String var5 = stat == null?"-":stat.format(StatsScreen.this.stats.getValue(stat));
   ...
   class MobsStatisticsList extends ObjectSelectionList {
      public MobsStatisticsList(Minecraft minecraft) {
         ...
         super(minecraft, var10002, var10003, 32, var10005, 9 * 4);
      ...
      class MobRow extends ObjectSelectionList.Entry {
         ...
         public void render(int var1, int var2, int var3, int var4, int var5, int var6, int var7, boolean var8, float var9) {
            String var10 = I18n.get(Util.makeDescriptionId("entity", EntityType.getKey(this.type)), new Object[0]);
         ...
         private String killsMessage(String var1, int var2) {
            ...
            return var2 == 0?I18n.get(var3 + ".none", new Object[]{var1}):I18n.get(var3, new Object[]{Integer.valueOf(var2), var1});
         }

         private String killedByMessage(String var1, int var2) {
            String var3 = Stats.ENTITY_KILLED_BY.getTranslationKey();
            return var2 == 0?I18n.get(var3 + ".none", new Object[]{var1}):I18n.get(var3, new Object[]{var1, Integer.valueOf(var2)});
         }
      }
   }
}
