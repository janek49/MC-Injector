   ...
   public void render(int var1, int var2, float var3) {
      ...
      for(int var6 = 0; var6 < 3; ++var6) {
         ...
         if(this.isHovering(60, 14 + 19 * var6, 108, 17, (double)var1, (double)var2) && var7 > 0 && var9 >= 0 && var8 != null) {
            ...
            var11.add("" + ChatFormatting.WHITE + ChatFormatting.ITALIC + I18n.get("container.enchant.clue", new Object[]{var8.getFullname(var9).getColoredString()}));
            if(!var4) {
               var11.add("");
               if(this.minecraft.player.experienceLevel < var7) {
                  var11.add(ChatFormatting.RED + I18n.get("container.enchant.level.requirement", new Object[]{Integer.valueOf(((EnchantmentMenu)this.menu).costs[var6])}));
               } else {
                  String var12;
                  if(var10 == 1) {
                     var12 = I18n.get("container.enchant.lapis.one", new Object[0]);
                  } else {
                     var12 = I18n.get("container.enchant.lapis.many", new Object[]{Integer.valueOf(var10)});
                  }

                  ChatFormatting var13 = var5 >= var10?ChatFormatting.GRAY:ChatFormatting.RED;
                  var11.add(var13 + "" + var12);
                  if(var10 == 1) {
                     var12 = I18n.get("container.enchant.level.one", new Object[0]);
                  } else {
                     var12 = I18n.get("container.enchant.level.many", new Object[]{Integer.valueOf(var10)});
                  }
