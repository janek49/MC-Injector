...
public abstract class AbstractCommandBlockEditScreen extends Screen {
   ...
   protected ParseResults currentParse;
   protected CompletableFuture pendingSuggestions;
   ...
   protected void init() {
      ...
      this.doneButton = (Button)this.addButton(new Button(this.width / 2 - 4 - 150, this.height / 4 + 120 + 12, 150, 20, I18n.get("gui.done", new Object[0]), (button) -> {
         this.onDone();
      }));
      this.cancelButton = (Button)this.addButton(new Button(this.width / 2 + 4, this.height / 4 + 120 + 12, 150, 20, I18n.get("gui.cancel", new Object[0]), (button) -> {
         this.onClose();
      }));
      this.outputButton = (Button)this.addButton(new Button(this.width / 2 + 150 - 20, this.getPreviousY(), 20, 20, "O", (button) -> {
   ...
   private void fillNodeUsage(ChatFormatting chatFormatting) {
      ...
      SuggestionContext<SharedSuggestionProvider> var3 = var2.findSuggestionContext(this.commandEdit.getCursorPosition());
   ...
   public void render(int var1, int var2, float var3) {
      ...
      this.drawCenteredString(this.font, I18n.get("advMode.setCommand", new Object[0]), this.width / 2, 20, 16777215);
      this.drawString(this.font, I18n.get("advMode.command", new Object[0]), this.width / 2 - 150, 40, 10526880);
      this.commandEdit.render(var1, var2, var3);
      int var4 = 75;
      if(!this.previousEdit.getValue().isEmpty()) {
         this.font.getClass();
         var4 = var4 + (5 * 9 + 1 + this.getPreviousY() - 135);
         this.drawString(this.font, I18n.get("advMode.previousOutput", new Object[0]), this.width / 2 - 150, var4 + 4, 10526880);
      ...
      if(this.suggestions != null) {
         ...
         for(String var6 : this.commandUsage) {
            fill(this.commandUsagePosition - 1, 72 + 12 * var4, this.commandUsagePosition + this.commandUsageWidth + 1, 84 + 12 * var4, Integer.MIN_VALUE);
            this.font.drawShadow(var6, (float)this.commandUsagePosition, (float)(74 + 12 * var4), -1);
            ++var4;
         }
      }
      ...
      if(this.pendingSuggestions != null && this.pendingSuggestions.isDone()) {
         ...
         if(!var1.isEmpty()) {
            ...
            for(Suggestion var4 : var1.getList()) {
               var2 = Math.max(var2, this.font.width(var4.getText()));
            }

            int var3 = Mth.clamp(this.commandEdit.getScreenX(var1.getRange().getStart()), 0, this.commandEdit.getScreenX(0) + this.commandEdit.getInnerWidth() - var2);
            this.suggestions = new AbstractCommandBlockEditScreen.SuggestionsList(var3, 72, var2, var1);
         }
      }

   }

   protected void setChatLine(String chatLine) {
      this.commandEdit.setValue(chatLine);
   }
   ...
   class SuggestionsList {
      ...
      private SuggestionsList(int var2, int var3, int var4, Suggestions suggestions) {
         ...
         this.rect = new Rect2i(var2 - 1, var3, var4 + 1, Math.min(suggestions.getList().size(), 7) * 12);
      ...
      public void render(int var1, int var2) {
         ...
         for(int var11 = 0; var11 < var3; ++var11) {
            ...
            GuiComponent.fill(this.rect.getX(), this.rect.getY() + 12 * var11, this.rect.getX() + this.rect.getWidth(), this.rect.getY() + 12 * var11 + 12, Integer.MIN_VALUE);
         ...
         if(var10) {
            Message var11 = ((Suggestion)this.suggestions.getList().get(this.current)).getTooltip();
            if(var11 != null) {
               AbstractCommandBlockEditScreen.this.renderTooltip(ComponentUtils.fromMessage(var11).getColoredString(), var1, var2);
            }
         }
