...
public class HorseInventoryScreen extends AbstractContainerScreen {
   ...
   public HorseInventoryScreen(HorseInventoryMenu horseInventoryMenu, Inventory inventory, AbstractHorse horse) {
      super(horseInventoryMenu, inventory, horse.getDisplayName());
      this.horse = horse;
