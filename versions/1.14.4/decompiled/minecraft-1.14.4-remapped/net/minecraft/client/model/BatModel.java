...
@ClientJarOnly
public class BatModel extends EntityModel {
   ...
   public void render(Bat bat, float var2, float var3, float var4, float var5, float var6, float var7) {
      this.setupAnim(bat, var2, var3, var4, var5, var6, var7);
      this.head.render(var7);
      this.body.render(var7);
   }

   public void setupAnim(Bat bat, float var2, float var3, float var4, float var5, float var6, float var7) {
      if(bat.isResting()) {
