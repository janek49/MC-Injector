...
public class RavagerModel extends EntityModel {
   ...
   public void render(Ravager ravager, float var2, float var3, float var4, float var5, float var6, float var7) {
      this.setupAnim(ravager, var2, var3, var4, var5, var6, var7);
   ...
   public void setupAnim(Ravager ravager, float var2, float var3, float var4, float var5, float var6, float var7) {
   ...
   public void prepareMobModel(Ravager ravager, float var2, float var3, float var4) {
      super.prepareMobModel(ravager, var2, var3, var4);
      int var5 = ravager.getStunnedTick();
      int var6 = ravager.getRoarTick();
      int var7 = 20;
      int var8 = ravager.getAttackTick();
      int var9 = 10;
      if(var8 > 0) {
         float var10 = this.triangleWave((float)var8 - var4, 10.0F);
         ...
         this.mouth.xRot = 3.1415927F * (var12?0.05F:0.01F);
         if(var12) {
            double var13 = (double)var5 / 40.0D;
            this.neck.x = (float)Math.sin(var13 * 10.0D) * 3.0F;
         } else if(var6 > 0) {
            float var13 = Mth.sin(((float)(20 - var6) - var4) / 20.0F * 3.1415927F * 0.25F);
