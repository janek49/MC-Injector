...
public class ArmorStandModel extends ArmorStandArmorModel {
   ...
   public void setupAnim(ArmorStand armorStand, float var2, float var3, float var4, float var5, float var6, float var7) {
      super.setupAnim(armorStand, var2, var3, var4, var5, var6, var7);
      ...
      this.basePlate.yRot = 0.017453292F * -armorStand.yRot;
      this.basePlate.zRot = 0.0F;
   }

   public void render(ArmorStand armorStand, float var2, float var3, float var4, float var5, float var6, float var7) {
      super.render(armorStand, var2, var3, var4, var5, var6, var7);
   ...
   public void translateToHand(float var1, HumanoidArm humanoidArm) {
      ...
      var3.visible = true;
      super.translateToHand(var1, humanoidArm);
      var3.visible = var4;
   }
}
