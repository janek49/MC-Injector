...
@ClientJarOnly
public class WolfModel extends EntityModel {
   ...
   public void render(Wolf wolf, float var2, float var3, float var4, float var5, float var6, float var7) {
      super.render(wolf, var2, var3, var4, var5, var6, var7);
      this.setupAnim(wolf, var2, var3, var4, var5, var6, var7);
      if(this.young) {
         float var8 = 2.0F;
   ...
   public void prepareMobModel(Wolf wolf, float var2, float var3, float var4) {
      if(wolf.isAngry()) {
         this.tail.yRot = 0.0F;
      } else {
      ...
      this.head.zRot = wolf.getHeadRollAngle(var4) + wolf.getBodyRollAngle(var4, 0.0F);
      this.upperBody.zRot = wolf.getBodyRollAngle(var4, -0.08F);
      this.body.zRot = wolf.getBodyRollAngle(var4, -0.16F);
      this.tail.zRot = wolf.getBodyRollAngle(var4, -0.2F);
   }

   public void setupAnim(Wolf wolf, float var2, float var3, float var4, float var5, float var6, float var7) {
      super.setupAnim(wolf, var2, var3, var4, var5, var6, var7);
