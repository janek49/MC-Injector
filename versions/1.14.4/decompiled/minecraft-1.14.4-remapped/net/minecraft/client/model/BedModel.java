...
public class BedModel extends Model {
   ...
   public void preparePiece(boolean b) {
      this.headPiece.visible = b;
      this.footPiece.visible = !b;
      this.legs[0].visible = !b;
      this.legs[1].visible = b;
      this.legs[2].visible = !b;
      this.legs[3].visible = b;
   }
}
