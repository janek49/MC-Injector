...
public class PolarBearModel extends QuadrupedModel {
   ...
   public void render(PolarBear polarBear, float var2, float var3, float var4, float var5, float var6, float var7) {
      this.setupAnim(polarBear, var2, var3, var4, var5, var6, var7);
      if(this.young) {
         float var8 = 2.0F;
   ...
   public void setupAnim(PolarBear polarBear, float var2, float var3, float var4, float var5, float var6, float var7) {
      super.setupAnim(polarBear, var2, var3, var4, var5, var6, var7);
      float var8 = var4 - (float)polarBear.tickCount;
      float var9 = polarBear.getStandingAnimationScale(var8);
      var9 = var9 * var9;
      ...
      this.leg2.xRot -= var9 * 3.1415927F * 0.45F;
      this.leg3.y = this.leg2.y;
      this.leg3.z = this.leg2.z;
      this.leg3.xRot -= var9 * 3.1415927F * 0.45F;
      if(this.young) {
      ...
      this.head.xRot += var9 * 3.1415927F * 0.15F;
   }
