...
public class IronGolemModel extends EntityModel {
   ...
   public void render(IronGolem ironGolem, float var2, float var3, float var4, float var5, float var6, float var7) {
      this.setupAnim(ironGolem, var2, var3, var4, var5, var6, var7);
   ...
   public void setupAnim(IronGolem ironGolem, float var2, float var3, float var4, float var5, float var6, float var7) {
   ...
   public void prepareMobModel(IronGolem ironGolem, float var2, float var3, float var4) {
      int var5 = ironGolem.getAttackAnimationTick();
      if(var5 > 0) {
         ...
         int var6 = ironGolem.getOfferFlowerTick();
         if(var6 > 0) {
