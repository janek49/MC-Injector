...
public class ParrotModel extends EntityModel {
   ...
   public void render(Parrot parrot, float var2, float var3, float var4, float var5, float var6, float var7) {
      this.render(var7);
   }

   public void setupAnim(Parrot parrot, float var2, float var3, float var4, float var5, float var6, float var7) {
      this.setupAnim(getState(parrot), parrot.tickCount, var2, var3, var4, var5, var6);
   }

   public void prepareMobModel(Parrot parrot, float var2, float var3, float var4) {
   ...
   private void setupAnim(ParrotModel.State parrotModel$State, int var2, float var3, float var4, float var5, float var6, float var7) {
      ...
      case PARTY:
         ...
         break;
      case STANDING:
         this.legLeft.xRot += Mth.cos(var3 * 0.6662F) * 1.4F * var4;
         this.legRight.xRot += Mth.cos(var3 * 0.6662F + 3.1415927F) * 1.4F * var4;
      case FLYING:
      case ON_SHOULDER:
      default:
   ...
   private void prepare(ParrotModel.State parrotModel$State) {
   ...
   private static ParrotModel.State getState(Parrot parrot) {
      return parrot.isPartyParrot()?ParrotModel.State.PARTY:(parrot.isSitting()?ParrotModel.State.SITTING:(parrot.isFlying()?ParrotModel.State.FLYING:ParrotModel.State.STANDING));
   }
