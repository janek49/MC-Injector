...
@ClientJarOnly
public class LlamaModel extends QuadrupedModel {
   ...
   public void render(AbstractChestedHorse abstractChestedHorse, float var2, float var3, float var4, float var5, float var6, float var7) {
      boolean var8 = !abstractChestedHorse.isBaby() && abstractChestedHorse.hasChest();
      this.setupAnim(abstractChestedHorse, var2, var3, var4, var5, var6, var7);
      if(this.young) {
         float var9 = 2.0F;
