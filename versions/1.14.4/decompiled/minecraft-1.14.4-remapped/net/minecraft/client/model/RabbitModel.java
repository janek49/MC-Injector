...
public class RabbitModel extends EntityModel {
   ...
   private void setRotation(ModelPart modelPart, float var2, float var3, float var4) {
      modelPart.xRot = var2;
      modelPart.yRot = var3;
      modelPart.zRot = var4;
   }

   public void render(Rabbit rabbit, float var2, float var3, float var4, float var5, float var6, float var7) {
      this.setupAnim(rabbit, var2, var3, var4, var5, var6, var7);
      if(this.young) {
         float var8 = 1.5F;
   ...
   public void setupAnim(Rabbit rabbit, float var2, float var3, float var4, float var5, float var6, float var7) {
      float var8 = var4 - (float)rabbit.tickCount;
      ...
      this.jumpRotation = Mth.sin(rabbit.getJumpCompletion(var8) * 3.1415927F);
   ...
   public void prepareMobModel(Rabbit rabbit, float var2, float var3, float var4) {
      super.prepareMobModel(rabbit, var2, var3, var4);
      this.jumpRotation = Mth.sin(rabbit.getJumpCompletion(var4) * 3.1415927F);
   }
