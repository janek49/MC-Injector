...
public class IllagerModel extends EntityModel implements ArmedModel, HeadedModel {
   ...
   public void setupAnim(AbstractIllager abstractIllager, float var2, float var3, float var4, float var5, float var6, float var7) {
      ...
      AbstractIllager.IllagerArmPose var8 = abstractIllager.getArmPose();
      if(var8 == AbstractIllager.IllagerArmPose.ATTACKING) {
         ...
         if(abstractIllager.getMainArm() == HumanoidArm.RIGHT) {
            ...
            this.rightArm.xRot += var9 * 2.2F - var10 * 0.4F;
            ...
            this.leftArm.xRot += var9 * 2.2F - var10 * 0.4F;
         }
         ...
         float var9 = Mth.clamp(this.itemUseTicks, 0.0F, 25.0F);
   ...
   public void prepareMobModel(AbstractIllager abstractIllager, float var2, float var3, float var4) {
      this.itemUseTicks = (float)abstractIllager.getTicksUsingItem();
      super.prepareMobModel(abstractIllager, var2, var3, var4);
   }
