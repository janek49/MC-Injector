...
public class TurtleModel extends QuadrupedModel {
   ...
   public void render(Turtle turtle, float var2, float var3, float var4, float var5, float var6, float var7) {
      this.setupAnim(turtle, var2, var3, var4, var5, var6, var7);
      if(this.young) {
         float var8 = 6.0F;
   ...
   public void setupAnim(Turtle turtle, float var2, float var3, float var4, float var5, float var6, float var7) {
      super.setupAnim(turtle, var2, var3, var4, var5, var6, var7);
      ...
      if(!turtle.isInWater() && turtle.onGround) {
         float var8 = turtle.isLayingEgg()?4.0F:1.0F;
         float var9 = turtle.isLayingEgg()?2.0F:1.0F;
         float var10 = 5.0F;
