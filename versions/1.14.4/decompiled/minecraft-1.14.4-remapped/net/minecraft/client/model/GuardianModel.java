...
public class GuardianModel extends EntityModel {
   ...
   public void render(Guardian guardian, float var2, float var3, float var4, float var5, float var6, float var7) {
      this.setupAnim(guardian, var2, var3, var4, var5, var6, var7);
      this.head.render(var7);
   }

   public void setupAnim(Guardian guardian, float var2, float var3, float var4, float var5, float var6, float var7) {
      float var8 = var4 - (float)guardian.tickCount;
      this.head.yRot = var5 * 0.017453292F;
      this.head.xRot = var6 * 0.017453292F;
      float var9 = (1.0F - guardian.getSpikesAnimation(var8)) * 0.55F;
      ...
      this.eye.z = -8.25F;
      Entity var10 = Minecraft.getInstance().getCameraEntity();
      if(guardian.hasActiveAttackTarget()) {
         var10 = guardian.getActiveAttackTarget();
      }

      if(var10 != null) {
         Vec3 var11 = var10.getEyePosition(0.0F);
         Vec3 var12 = guardian.getEyePosition(0.0F);
         ...
         Vec3 var15 = guardian.getViewVector(0.0F);
      ...
      float var11 = guardian.getTailAnimation(var8);
      this.tailParts[0].yRot = Mth.sin(var11) * 3.1415927F * 0.05F;
      this.tailParts[1].yRot = Mth.sin(var11) * 3.1415927F * 0.1F;
      this.tailParts[1].x = -1.5F;
      this.tailParts[1].y = 0.5F;
      this.tailParts[1].z = 14.0F;
      this.tailParts[2].yRot = Mth.sin(var11) * 3.1415927F * 0.15F;
