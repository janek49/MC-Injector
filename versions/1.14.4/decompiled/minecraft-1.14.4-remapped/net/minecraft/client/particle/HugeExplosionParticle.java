...
public class HugeExplosionParticle extends TextureSheetParticle {
   ...
   private HugeExplosionParticle(Level level, double var2, double var4, double var6, double var8, SpriteSet sprites) {
   ...
   public static class Provider implements ParticleProvider {
      ...
      public Particle createParticle(SimpleParticleType simpleParticleType, Level level, double var3, double var5, double var7, double var9, double var11, double var13) {
         return new HugeExplosionParticle(level, var3, var5, var7, var9, this.sprites);
      }
   }
}
