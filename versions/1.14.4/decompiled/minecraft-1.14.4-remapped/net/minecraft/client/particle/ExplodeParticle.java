...
public class ExplodeParticle extends TextureSheetParticle {
   ...
   protected ExplodeParticle(Level level, double var2, double var4, double var6, double var8, double var10, double var12, SpriteSet sprites) {
   ...
   public static class Provider implements ParticleProvider {
      ...
      public Particle createParticle(SimpleParticleType simpleParticleType, Level level, double var3, double var5, double var7, double var9, double var11, double var13) {
         return new ExplodeParticle(level, var3, var5, var7, var9, var11, var13, this.sprites);
      }
   }
}
