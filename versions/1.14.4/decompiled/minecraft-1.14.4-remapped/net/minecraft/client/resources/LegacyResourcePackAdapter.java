...
public class LegacyResourcePackAdapter implements Pack {
   ...
   public LegacyResourcePackAdapter(Pack source, Map map) {
      this.source = source;
      Builder<ResourceLocation, ResourceLocation> var3 = ImmutableMap.builder();

      for(Entry<ResourceLocation, ResourceLocation> var5 : map.entrySet()) {
         var3.put(var5);
