...
public class LayeredTexture extends AbstractTexture {
   ...
   public void load(ResourceManager resourceManager) throws IOException {
      Iterator<String> var2 = this.layerPaths.iterator();
      String var3 = (String)var2.next();

      try {
         Resource var4 = resourceManager.getResource(new ResourceLocation(var3));
         Throwable var5 = null;
         ...
         try {
            ...
            try {
               while(true) {
                  ...
                  if(var8 != null) {
                     Resource var9 = resourceManager.getResource(new ResourceLocation(var8));
