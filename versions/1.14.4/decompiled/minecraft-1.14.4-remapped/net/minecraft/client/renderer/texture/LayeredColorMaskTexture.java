...
public class LayeredColorMaskTexture extends AbstractTexture {
   ...
   private final List layerMaskPaths;
   private final List layerColors;

   public LayeredColorMaskTexture(ResourceLocation baseLayerResource, List layerMaskPaths, List layerColors) {
      this.baseLayerResource = baseLayerResource;
   ...
   public void load(ResourceManager resourceManager) throws IOException {
      try {
         Resource var2 = resourceManager.getResource(this.baseLayerResource);
         Throwable var3 = null;
            ...
            try {
               ...
               try {
                  ...
                  for(int var8 = 0; var8 < 17 && var8 < this.layerMaskPaths.size() && var8 < this.layerColors.size(); ++var8) {
                     ...
                     if(var9 != null) {
                        Resource var10 = resourceManager.getResource(new ResourceLocation(var9));
