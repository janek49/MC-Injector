...
public class IronGolemFlowerLayer extends RenderLayer {
   public IronGolemFlowerLayer(RenderLayerParent renderLayerParent) {
      super(renderLayerParent);
   }

   public void render(IronGolem ironGolem, float var2, float var3, float var4, float var5, float var6, float var7, float var8) {
      if(ironGolem.getOfferFlowerTick() != 0) {
         ...
         int var10 = ironGolem.getLightColor();
