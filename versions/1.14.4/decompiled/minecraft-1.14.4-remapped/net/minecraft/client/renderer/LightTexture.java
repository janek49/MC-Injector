...
public class LightTexture implements AutoCloseable {
   ...
   public LightTexture(GameRenderer renderer) {
      ...
      if(this.updateLightTexture) {
         ...
         if(var2 != null) {
            ...
            if(this.minecraft.player.hasEffect(MobEffects.NIGHT_VISION)) {
               var5 = this.renderer.getNightVisionScale(this.minecraft.player, f);
            ...
            for(int var7 = 0; var7 < 16; ++var7) {
               for(int var8 = 0; var8 < 16; ++var8) {
                  ...
                  if(this.renderer.getDarkenWorldAmount(f) > 0.0F) {
                     float var20 = this.renderer.getDarkenWorldAmount(f);
                  ...
                  float var20 = (float)this.minecraft.options.gamma;
