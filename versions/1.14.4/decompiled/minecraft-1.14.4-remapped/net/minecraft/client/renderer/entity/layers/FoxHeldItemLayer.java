...
public class FoxHeldItemLayer extends RenderLayer {
   public FoxHeldItemLayer(RenderLayerParent renderLayerParent) {
      super(renderLayerParent);
   }

   public void render(Fox fox, float var2, float var3, float var4, float var5, float var6, float var7, float var8) {
      ItemStack var9 = fox.getItemBySlot(EquipmentSlot.MAINHAND);
      if(!var9.isEmpty()) {
         boolean var10 = fox.isSleeping();
         boolean var11 = fox.isBaby();
         ...
         float var12 = fox.getHeadRollAngle(var4) * 57.295776F;
         ...
         Minecraft.getInstance().getItemRenderer().renderWithMobState(var9, fox, ItemTransforms.TransformType.GROUND, false);
