...
public class MushroomCowMushroomLayer extends RenderLayer {
   public MushroomCowMushroomLayer(RenderLayerParent renderLayerParent) {
      super(renderLayerParent);
   }

   public void render(MushroomCow mushroomCow, float var2, float var3, float var4, float var5, float var6, float var7, float var8) {
      if(!mushroomCow.isBaby() && !mushroomCow.isInvisible()) {
         BlockState var9 = mushroomCow.getMushroomType().getBlockState();
