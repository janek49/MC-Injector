...
public class CreeperRenderer extends MobRenderer {
   ...
   protected void scale(Creeper creeper, float var2) {
      float var3 = creeper.getSwelling(var2);
   ...
   protected int getOverlayColor(Creeper creeper, float var2, float var3) {
      float var4 = creeper.getSwelling(var3);
