...
public class ShulkerRenderer extends MobRenderer {
   ...
   public void render(Shulker shulker, double var2, double var4, double var6, float var8, float var9) {
      int var10 = shulker.getClientSideTeleportInterpolation();
      if(var10 > 0 && shulker.hasValidInterpolationPositions()) {
         BlockPos var11 = shulker.getAttachPosition();
         BlockPos var12 = shulker.getOldAttachPosition();
         ...
         super.render((Mob)shulker, var2 - var15, var4 - var17, var6 - var19, var8, var9);
      } else {
         super.render((Mob)shulker, var2, var4, var6, var8, var9);
      }

   }

   public boolean shouldRender(Shulker shulker, Culler culler, double var3, double var5, double var7) {
      if(super.shouldRender((Mob)shulker, culler, var3, var5, var7)) {
         return true;
      } else {
         if(shulker.getClientSideTeleportInterpolation() > 0 && shulker.hasValidInterpolationPositions()) {
            BlockPos var9 = shulker.getOldAttachPosition();
            BlockPos var10 = shulker.getAttachPosition();
            ...
            if(culler.isVisible(new AABB(var12.x, var12.y, var12.z, var11.x, var11.y, var11.z))) {
               return true;
            }
         }
   ...
   protected void setupRotations(Shulker shulker, float var2, float var3, float var4) {
      super.setupRotations(shulker, var2, var3, var4);
   ...
   protected void scale(Shulker shulker, float var2) {
      float var3 = 0.999F;
