...
public class PaintingRenderer extends EntityRenderer {
   ...
   public void render(Painting painting, double var2, double var4, double var6, float var8, float var9) {
   ...
   private void renderPainting(Painting painting, int var2, int var3, TextureAtlasSprite var4, TextureAtlasSprite var5) {
      ...
      for(int var27 = 0; var27 < var21; ++var27) {
         for(int var28 = 0; var28 < var22; ++var28) {
            ...
            this.setBrightness(painting, (var29 + var30) / 2.0F, (var31 + var32) / 2.0F);
   ...
   private void setBrightness(Painting painting, float var2, float var3) {
      int var4 = Mth.floor(painting.x);
      int var5 = Mth.floor(painting.y + (double)(var3 / 16.0F));
      int var6 = Mth.floor(painting.z);
      Direction var7 = painting.getDirection();
      if(var7 == Direction.NORTH) {
         var4 = Mth.floor(painting.x + (double)(var2 / 16.0F));
      }

      if(var7 == Direction.WEST) {
         var6 = Mth.floor(painting.z - (double)(var2 / 16.0F));
      }
