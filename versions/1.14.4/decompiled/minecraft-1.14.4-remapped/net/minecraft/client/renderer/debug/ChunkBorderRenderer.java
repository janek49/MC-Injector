...
public class ChunkBorderRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   public void render(long l) {
      ...
      for(int var20 = 2; var20 < 16; var20 += 2) {
      ...
      for(int var20 = 0; var20 <= 256; var20 += 2) {
         double var21 = (double)var20 - var8;
         var5.vertex(var16, var21, var18).color(1.0F, 1.0F, 0.0F, 0.0F).endVertex();
         var5.vertex(var16, var21, var18).color(1.0F, 1.0F, 0.0F, 1.0F).endVertex();
         var5.vertex(var16, var21, var18 + 16.0D).color(1.0F, 1.0F, 0.0F, 1.0F).endVertex();
         var5.vertex(var16 + 16.0D, var21, var18 + 16.0D).color(1.0F, 1.0F, 0.0F, 1.0F).endVertex();
         var5.vertex(var16 + 16.0D, var21, var18).color(1.0F, 1.0F, 0.0F, 1.0F).endVertex();
         var5.vertex(var16, var21, var18).color(1.0F, 1.0F, 0.0F, 1.0F).endVertex();
         var5.vertex(var16, var21, var18).color(1.0F, 1.0F, 0.0F, 0.0F).endVertex();
      }
      ...
      for(int var20 = 0; var20 <= 16; var20 += 16) {
         for(int var21 = 0; var21 <= 16; var21 += 16) {
      ...
      for(int var20 = 0; var20 <= 256; var20 += 16) {
         double var21 = (double)var20 - var8;
         var5.vertex(var16, var21, var18).color(0.25F, 0.25F, 1.0F, 0.0F).endVertex();
         var5.vertex(var16, var21, var18).color(0.25F, 0.25F, 1.0F, 1.0F).endVertex();
         var5.vertex(var16, var21, var18 + 16.0D).color(0.25F, 0.25F, 1.0F, 1.0F).endVertex();
         var5.vertex(var16 + 16.0D, var21, var18 + 16.0D).color(0.25F, 0.25F, 1.0F, 1.0F).endVertex();
         var5.vertex(var16 + 16.0D, var21, var18).color(0.25F, 0.25F, 1.0F, 1.0F).endVertex();
         var5.vertex(var16, var21, var18).color(0.25F, 0.25F, 1.0F, 1.0F).endVertex();
         var5.vertex(var16, var21, var18).color(0.25F, 0.25F, 1.0F, 0.0F).endVertex();
      }
