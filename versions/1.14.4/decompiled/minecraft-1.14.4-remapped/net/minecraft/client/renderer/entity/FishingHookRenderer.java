...
public class FishingHookRenderer extends EntityRenderer {
   ...
   public void render(FishingHook fishingHook, double var2, double var4, double var6, float var8, float var9) {
      Player var10 = fishingHook.getOwner();
      if(var10 != null && !this.solidRender) {
         ...
         if((this.entityRenderDispatcher.options == null || this.entityRenderDispatcher.options.thirdPersonView <= 0) && var10 == Minecraft.getInstance().player) {
            double var37 = this.entityRenderDispatcher.options.fov;
            var37 = var37 / 100.0D;
         ...
         double var37 = Mth.lerp((double)var9, fishingHook.xo, fishingHook.x);
         double var39 = Mth.lerp((double)var9, fishingHook.yo, fishingHook.y) + 0.25D;
         double var41 = Mth.lerp((double)var9, fishingHook.zo, fishingHook.z);
         double var43 = (double)((float)(var29 - var37));
         double var45 = (double)((float)(var31 - var39)) + var35;
         ...
         super.render(fishingHook, var2, var4, var6, var8, var9);
      }
   }
