...
public class ExperienceOrbRenderer extends EntityRenderer {
   ...
   public void render(ExperienceOrb experienceOrb, double var2, double var4, double var6, float var8, float var9) {
      if(!this.solidRender && Minecraft.getInstance().getEntityRenderDispatcher().options != null) {
         ...
         Lighting.turnOn();
         int var10 = experienceOrb.getIcon();
         ...
         super.render(experienceOrb, var2, var4, var6, var8, var9);
      }
   }
