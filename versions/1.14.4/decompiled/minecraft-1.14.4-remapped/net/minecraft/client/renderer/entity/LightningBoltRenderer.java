...
public class LightningBoltRenderer extends EntityRenderer {
   ...
   public void render(LightningBolt lightningBolt, double var2, double var4, double var6, float var8, float var9) {
      ...
      double[] vars12 = new double[8];
      double[] vars13 = new double[8];
      double var14 = 0.0D;
      double var16 = 0.0D;
      Random var18 = new Random(lightningBolt.seed);
      ...
      for(int var18 = 0; var18 < 4; ++var18) {
         Random var19 = new Random(lightningBolt.seed);
         ...
         for(int var20 = 0; var20 < 3; ++var20) {
            ...
            double var23 = vars12[var21] - var14;
            double var25 = vars13[var21] - var16;
            ...
            for(int var27 = var21; var27 >= var22; --var27) {
               ...
               float var34 = 0.45F;
               float var35 = 0.5F;
               double var36 = 0.1D + (double)var18 * 0.2D;
               if(var20 == 0) {
                  var36 *= (double)var27 * 0.1D + 1.0D;
               }

               double var38 = 0.1D + (double)var18 * 0.2D;
               if(var20 == 0) {
