...
@ClientJarOnly
public class EnderDragonDeathLayer extends RenderLayer {
   public EnderDragonDeathLayer(RenderLayerParent renderLayerParent) {
      super(renderLayerParent);
   }

   public void render(EnderDragon enderDragon, float var2, float var3, float var4, float var5, float var6, float var7, float var8) {
      if(enderDragon.dragonDeathTime > 0) {
         Tesselator var9 = Tesselator.getInstance();
         BufferBuilder var10 = var9.getBuilder();
         Lighting.turnOff();
         float var11 = ((float)enderDragon.dragonDeathTime + var4) / 200.0F;
         float var12 = 0.0F;
         if(var11 > 0.8F) {
