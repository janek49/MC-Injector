...
public class GuardianRenderer extends MobRenderer {
   ...
   protected GuardianRenderer(EntityRenderDispatcher entityRenderDispatcher, float var2) {
      super(entityRenderDispatcher, new GuardianModel(), var2);
   }

   public boolean shouldRender(Guardian guardian, Culler culler, double var3, double var5, double var7) {
      if(super.shouldRender((Mob)guardian, culler, var3, var5, var7)) {
         return true;
      } else {
         if(guardian.hasActiveAttackTarget()) {
            LivingEntity var9 = guardian.getActiveAttackTarget();
            if(var9 != null) {
               Vec3 var10 = this.getPosition(var9, (double)var9.getBbHeight() * 0.5D, 1.0F);
               Vec3 var11 = this.getPosition(guardian, (double)guardian.getEyeHeight(), 1.0F);
               if(culler.isVisible(new AABB(var11.x, var11.y, var11.z, var10.x, var10.y, var10.z))) {
                  return true;
               }
            }
         }
   ...
   private Vec3 getPosition(LivingEntity livingEntity, double var2, float var4) {
      double var5 = Mth.lerp((double)var4, livingEntity.xOld, livingEntity.x);
      double var7 = Mth.lerp((double)var4, livingEntity.yOld, livingEntity.y) + var2;
      double var9 = Mth.lerp((double)var4, livingEntity.zOld, livingEntity.z);
      return new Vec3(var5, var7, var9);
   }

   public void render(Guardian guardian, double var2, double var4, double var6, float var8, float var9) {
      super.render((Mob)guardian, var2, var4, var6, var8, var9);
      LivingEntity var10 = guardian.getActiveAttackTarget();
      if(var10 != null) {
         float var11 = guardian.getAttackAnimationScale(var9);
         ...
         float var15 = (float)guardian.level.getGameTime() + var9;
         ...
         Vec3 var19 = this.getPosition(guardian, (double)var17, var9);
