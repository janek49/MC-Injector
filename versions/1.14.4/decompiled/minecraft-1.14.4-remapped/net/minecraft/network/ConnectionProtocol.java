...
public enum ConnectionProtocol {
   ...
   protected ConnectionProtocol addPacket(PacketFlow packetFlow, Class class) {
      BiMap<Integer, Class<? extends Packet<?>>> var3 = (BiMap)this.packets.get(packetFlow);
      if(var3 == null) {
         var3 = HashBiMap.create();
         this.packets.put(packetFlow, var3);
      }

      if(var3.containsValue(class)) {
         String var4 = packetFlow + " packet " + class + " is already known to ID " + var3.inverse().get(class);
         LogManager.getLogger().fatal(var4);
         throw new IllegalArgumentException(var4);
      } else {
         var3.put(Integer.valueOf(var3.size()), class);
         return this;
      }
   }
   ...
   @Nullable
   public Packet createPacket(PacketFlow packetFlow, int var2) throws IllegalAccessException, InstantiationException {
      Class<? extends Packet<?>> var3 = (Class)((BiMap)this.packets.get(packetFlow)).get(Integer.valueOf(var2));
   ...
   static {
      for(ConnectionProtocol var3 : values()) {
         ...
         for(PacketFlow var6 : var3.packets.keySet()) {
            for(Class<? extends Packet<?>> var8 : ((BiMap)var3.packets.get(var6)).values()) {
               ...
               PROTOCOL_BY_PACKET.put(var8, var3);
            }
         }
      }
