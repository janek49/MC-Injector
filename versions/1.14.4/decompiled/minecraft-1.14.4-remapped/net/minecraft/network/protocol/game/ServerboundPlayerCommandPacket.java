...
public class ServerboundPlayerCommandPacket implements Packet {
   ...
   public ServerboundPlayerCommandPacket(Entity entity, ServerboundPlayerCommandPacket.Action serverboundPlayerCommandPacket$Action) {
      this(entity, serverboundPlayerCommandPacket$Action, 0);
   }
   ...
   public void read(FriendlyByteBuf friendlyByteBuf) throws IOException {
      ...
      this.action = (ServerboundPlayerCommandPacket.Action)friendlyByteBuf.readEnum(ServerboundPlayerCommandPacket.Action.class);
