...
public class DebugPackets {
   ...
   public static void sendPathFindingPacket(Level level, Mob mob, @Nullable Path path, float var3) {
   }
   ...
   public static void sendRaids(ServerLevel serverLevel, Collection collection) {
   }
