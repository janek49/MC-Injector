...
public class ClientboundBossEventPacket implements Packet {
   ...
   public void read(FriendlyByteBuf friendlyByteBuf) throws IOException {
      ...
      this.operation = (ClientboundBossEventPacket.Operation)friendlyByteBuf.readEnum(ClientboundBossEventPacket.Operation.class);
      switch(this.operation) {
      case ADD:
         this.name = friendlyByteBuf.readComponent();
         this.pct = friendlyByteBuf.readFloat();
         this.color = (BossEvent.BossBarColor)friendlyByteBuf.readEnum(BossEvent.BossBarColor.class);
         this.overlay = (BossEvent.BossBarOverlay)friendlyByteBuf.readEnum(BossEvent.BossBarOverlay.class);
