...
public class ParticleTypes {
   ...
   public static final ParticleType BLOCK = register("block", BlockParticleOption.DESERIALIZER);
   ...
   public static final ParticleType DUST = register("dust", DustParticleOptions.DESERIALIZER);
   ...
   public static final ParticleType FALLING_DUST = register("falling_dust", BlockParticleOption.DESERIALIZER);
   ...
   public static final ParticleType ITEM = register("item", ItemParticleOption.DESERIALIZER);
   ...
   private static SimpleParticleType register(String string, boolean var1) {
      return (SimpleParticleType)Registry.register(Registry.PARTICLE_TYPE, (String)string, new SimpleParticleType(var1));
   }

   private static ParticleType register(String string, ParticleOptions.Deserializer particleOptions$Deserializer) {
      return (ParticleType)Registry.register(Registry.PARTICLE_TYPE, (String)string, new ParticleType(false, particleOptions$Deserializer));
   }
}
