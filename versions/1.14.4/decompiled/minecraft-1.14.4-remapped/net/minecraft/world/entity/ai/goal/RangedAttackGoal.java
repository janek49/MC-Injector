...
public class RangedAttackGoal extends Goal {
   ...
   public RangedAttackGoal(RangedAttackMob rangedAttackMob, double var2, int var4, float var5) {
      this(rangedAttackMob, var2, var4, var4, var5);
   }
   ...
   public void tick() {
      ...
      if(--this.attackTime == 0) {
         ...
         float var4 = Mth.sqrt(var1) / this.attackRadius;
