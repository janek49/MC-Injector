...
public class FleeSunGoal extends Goal {
   ...
   public boolean canUse() {
      return this.mob.getTarget() != null?false:(!this.level.isDay()?false:(!this.mob.isOnFire()?false:(!this.level.canSeeSky(new BlockPos(this.mob.x, this.mob.getBoundingBox().minY, this.mob.z))?false:(!this.mob.getItemBySlot(EquipmentSlot.HEAD).isEmpty()?false:this.setWantedPos()))));
   }
