...
public class Chicken extends Animal {
   private static final Ingredient FOOD_ITEMS = Ingredient.of(new ItemLike[]{Items.WHEAT_SEEDS, Items.MELON_SEEDS, Items.PUMPKIN_SEEDS, Items.BEETROOT_SEEDS});
   public float flap;
   ...
   public Chicken(EntityType entityType, Level level) {
   ...
   public void positionRider(Entity entity) {
      ...
      float var4 = 0.1F;
      float var5 = 0.0F;
      entity.setPos(this.x + (double)(0.1F * var2), this.y + (double)(this.getBbHeight() * 0.5F) + entity.getRidingHeight() + 0.0D, this.z - (double)(0.1F * var3));
   ...
   public void setChickenJockey(boolean chickenJockey) {
      this.isChickenJockey = chickenJockey;
   }
