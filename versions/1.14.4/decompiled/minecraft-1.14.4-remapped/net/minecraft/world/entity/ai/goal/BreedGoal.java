...
public class BreedGoal extends Goal {
   ...
   public BreedGoal(Animal animal, double var2) {
      this(animal, var2, animal.getClass());
   }

   public BreedGoal(Animal animal, double speedModifier, Class partnerClass) {
      this.animal = animal;
   ...
   private Animal getFreePartner() {
      List<Animal> var1 = this.level.getNearbyEntities(this.partnerClass, PARTNER_TARGETING, this.animal, this.animal.getBoundingBox().inflate(8.0D));
