...
public class ThrownEgg extends ThrowableItemProjectile {
   public ThrownEgg(EntityType entityType, Level level) {
   ...
   public ThrownEgg(Level level, double var2, double var4, double var6) {
      super(EntityType.EGG, var2, var4, var6, level);
   }
