...
public class Vex extends Monster {
   protected static final EntityDataAccessor DATA_FLAGS_ID = SynchedEntityData.defineId(Vex.class, EntityDataSerializers.BYTE);
   private Mob owner;
   @Nullable
   ...
   public Vex(EntityType entityType, Level level) {
   ...
   private boolean getVexFlag(int i) {
      int var2 = ((Byte)this.entityData.get(DATA_FLAGS_ID)).byteValue();
      return (var2 & i) != 0;
   }

   private void setVexFlag(int var1, boolean var2) {
      int var3 = ((Byte)this.entityData.get(DATA_FLAGS_ID)).byteValue();
      if(var2) {
         var3 = var3 | var1;
      } else {
         var3 = var3 & ~var1;
      ...
      this.entityData.set(DATA_FLAGS_ID, Byte.valueOf((byte)(var3 & 255)));
   }
   ...
   class VexChargeAttackGoal extends Goal {
      ...
      public boolean canUse() {
         return Vex.this.getTarget() != null && !Vex.this.getMoveControl().hasWanted() && Vex.this.random.nextInt(7) == 0?Vex.this.distanceToSqr(Vex.this.getTarget()) > 4.0D:false;
      }
         ...
         if(this.operation == MoveControl.Operation.MOVE_TO) {
            ...
            if(var2 < Vex.this.getBoundingBox().getSize()) {
               ...
               if(Vex.this.getTarget() == null) {
                  ...
                  double var4 = Vex.this.getTarget().x - Vex.this.x;
                  double var6 = Vex.this.getTarget().z - Vex.this.z;
                  Vex.this.yRot = -((float)Mth.atan2(var4, var6)) * 57.295776F;
                  Vex.this.yBodyRot = Vex.this.yRot;
               }
            }
