...
public class EatBlockGoal extends Goal {
   private static final Predicate IS_TALL_GRASS = BlockStatePredicate.forBlock(Blocks.GRASS);
   ...
   public boolean canUse() {
      if(this.mob.getRandom().nextInt(this.mob.isBaby()?50:1000) != 0) {
         ...
         return IS_TALL_GRASS.test(this.level.getBlockState(var1))?true:this.level.getBlockState(var1.below()).getBlock() == Blocks.GRASS_BLOCK;
      }
   }
