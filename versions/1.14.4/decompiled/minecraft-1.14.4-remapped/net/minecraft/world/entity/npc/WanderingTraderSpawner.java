...
public class WanderingTraderSpawner {
   ...
   public WanderingTraderSpawner(ServerLevel level) {
      this.level = level;
      this.tickDelay = 1200;
      LevelData var2 = level.getLevelData();
   ...
   private boolean spawn() {
      Player var1 = this.level.getRandomPlayer();
      if(var1 == null) {
         return true;
         ...
         Optional<BlockPos> var5 = var4.find(PoiType.MEETING.getPredicate(), (blockPos) -> {
            return true;
   ...
   private void tryToSpawnLlamaFor(WanderingTrader wanderingTrader, int var2) {
      BlockPos var3 = this.findSpawnPositionNear(new BlockPos(wanderingTrader), var2);
      if(var3 != null) {
         ...
         if(var4 != null) {
            var4.setLeashedTo(wanderingTrader, true);
         }
      }
   }
