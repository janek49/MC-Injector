...
public class Cow extends Animal {
   public Cow(EntityType entityType, Level level) {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(3, new TemptGoal(this, 1.25D, Ingredient.of(new ItemLike[]{Items.WHEAT}), false));
   ...
   public boolean mobInteract(Player player, InteractionHand interactionHand) {
      ...
      if(var3.getItem() == Items.BUCKET && !player.abilities.instabuild && !this.isBaby()) {
