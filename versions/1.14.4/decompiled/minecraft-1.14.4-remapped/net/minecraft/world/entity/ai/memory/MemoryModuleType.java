...
public class MemoryModuleType {
   ...
   private MemoryModuleType(Optional deserializer) {
   ...
   private static MemoryModuleType register(String string, Optional optional) {
      return (MemoryModuleType)Registry.register(Registry.MEMORY_MODULE_TYPE, (ResourceLocation)(new ResourceLocation(string)), new MemoryModuleType(optional));
   }

   private static MemoryModuleType register(String string) {
      return (MemoryModuleType)Registry.register(Registry.MEMORY_MODULE_TYPE, (ResourceLocation)(new ResourceLocation(string)), new MemoryModuleType(Optional.empty()));
   }
}
