...
public abstract class DoorInteractGoal extends Goal {
   ...
   protected boolean isOpen() {
      if(!this.hasDoor) {
         ...
         if(!(var1.getBlock() instanceof DoorBlock)) {
            ...
            return ((Boolean)var1.getValue(DoorBlock.OPEN)).booleanValue();
         }
      }
   }
   ...
   protected void setOpen(boolean open) {
      if(this.hasDoor) {
         ...
         if(var2.getBlock() instanceof DoorBlock) {
            ((DoorBlock)var2.getBlock()).setOpen(this.mob.level, this.doorPos, open);
         }
      }
   ...
   public static boolean isDoor(Level level, BlockPos blockPos) {
      BlockState var2 = level.getBlockState(blockPos);
