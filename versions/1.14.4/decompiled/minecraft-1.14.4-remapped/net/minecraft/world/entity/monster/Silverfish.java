...
public class Silverfish extends Monster {
   ...
   public Silverfish(EntityType entityType, Level level) {
   ...
   public static boolean checkSliverfishSpawnRules(EntityType entityType, LevelAccessor levelAccessor, MobSpawnType mobSpawnType, BlockPos blockPos, Random random) {
   ...
   static class SilverfishMergeWithStoneGoal extends RandomStrollGoal {
      ...
      public void start() {
         if(!this.doMerge) {
            ...
            LevelAccessor var1 = this.mob.level;
            BlockPos var2 = (new BlockPos(this.mob.x, this.mob.y + 0.5D, this.mob.z)).relative(this.selectedDirection);
