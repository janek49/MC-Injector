...
public class SpawnPlacements {
   ...
   private static void register(EntityType entityType, SpawnPlacements.Type spawnPlacements$Type, Heightmap.Types heightmap$Types, SpawnPlacements.SpawnPredicate spawnPlacements$SpawnPredicate) {
      SpawnPlacements.Data var4 = (SpawnPlacements.Data)DATA_BY_TYPE.put(entityType, new SpawnPlacements.Data(heightmap$Types, spawnPlacements$Type, spawnPlacements$SpawnPredicate));
      if(var4 != null) {
   ...
   public static SpawnPlacements.Type getPlacementType(EntityType entityType) {
      SpawnPlacements.Data var1 = (SpawnPlacements.Data)DATA_BY_TYPE.get(entityType);
   ...
   public static boolean checkSpawnRules(EntityType entityType, LevelAccessor levelAccessor, MobSpawnType mobSpawnType, BlockPos blockPos, Random random) {
      SpawnPlacements.Data var5 = (SpawnPlacements.Data)DATA_BY_TYPE.get(entityType);
      return var5 == null || var5.predicate.test(entityType, levelAccessor, mobSpawnType, blockPos, random);
   }
   ...
   static class Data {
      ...
      public Data(Heightmap.Types heightMap, SpawnPlacements.Type placement, SpawnPlacements.SpawnPredicate predicate) {
