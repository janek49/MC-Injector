...
public interface VillagerType {
   ...
   Map BY_BIOME = (Map)Util.make(Maps.newHashMap(), (hashMap) -> {
   ...
   static default VillagerType register(final String string) {
      return (VillagerType)Registry.register(Registry.VILLAGER_TYPE, (ResourceLocation)(new ResourceLocation(string)), new VillagerType() {
   ...
   static default VillagerType byBiome(Biome biome) {
