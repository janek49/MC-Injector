...
public class MeleeAttackGoal extends Goal {
   ...
   public MeleeAttackGoal(PathfinderMob mob, double speedModifier, boolean trackTarget) {
      this.mob = mob;
   ...
   public boolean canUse() {
      ...
      if(var1 - this.lastUpdate < 20L) {
         ...
         if(var3 == null) {
            ...
            return this.path != null?true:this.getAttackReachSqr(var3) >= this.mob.distanceToSqr(var3.x, var3.getBoundingBox().minY, var3.z);
         }
      }
   }
   ...
   public boolean canContinueToUse() {
      ...
      return var1 == null?false:(!var1.isAlive()?false:(!this.trackTarget?!this.mob.getNavigation().isDone():(!this.mob.isWithinRestriction(new BlockPos(var1))?false:!(var1 instanceof Player) || !var1.isSpectator() && !((Player)var1).isCreative())));
   }
