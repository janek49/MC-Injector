...
public class IronGolem extends AbstractGolem {
   protected static final EntityDataAccessor DATA_FLAGS_ID = SynchedEntityData.defineId(IronGolem.class, EntityDataSerializers.BYTE);
   private int attackAnimationTick;
   private int offerFlowerTick;

   public IronGolem(EntityType entityType, Level level) {
   ...
   public boolean doHurtTarget(Entity entity) {
      ...
      boolean var2 = entity.hurt(DamageSource.mobAttack(this), (float)(7 + this.random.nextInt(15)));
      if(var2) {
   ...
   public void offerFlower(boolean b) {
      if(b) {
         this.offerFlowerTick = 400;
   ...
   public boolean checkSpawnObstruction(LevelReader levelReader) {
      ...
      BlockState var4 = levelReader.getBlockState(var3);
      if(!var4.entityCanStandOn(levelReader, var3, this)) {
         return false;
      } else {
         for(int var5 = 1; var5 < 3; ++var5) {
            BlockPos var6 = var2.above(var5);
            BlockState var7 = levelReader.getBlockState(var6);
            if(!NaturalSpawner.isValidEmptySpawnBlock(levelReader, var6, var7, var7.getFluidState())) {
               return false;
            }
         }

         return NaturalSpawner.isValidEmptySpawnBlock(levelReader, var2, levelReader.getBlockState(var2), Fluids.EMPTY.defaultFluidState()) && levelReader.isUnobstructed(this);
      }
   }
}
