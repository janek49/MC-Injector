...
public class VillagerProfession {
   ...
   public static final VillagerProfession FARMER = register("farmer", PoiType.FARMER, ImmutableSet.of(Items.WHEAT, Items.WHEAT_SEEDS, Items.BEETROOT_SEEDS), ImmutableSet.of(Blocks.FARMLAND));
   ...
   private VillagerProfession(String name, PoiType jobPoiType, ImmutableSet requestedItems, ImmutableSet secondaryPoi) {
      this.name = name;
   ...
   static VillagerProfession register(String string, PoiType poiType, ImmutableSet var2, ImmutableSet var3) {
      return (VillagerProfession)Registry.register(Registry.VILLAGER_PROFESSION, (ResourceLocation)(new ResourceLocation(string)), new VillagerProfession(string, poiType, var2, var3));
   }
}
