...
public class SnowGolem extends AbstractGolem implements RangedAttackMob {
   ...
   public SnowGolem(EntityType entityType, Level level) {
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(DATA_PUMPKIN_ID, Byte.valueOf((byte)16));
   }
   ...
   public void performRangedAttack(LivingEntity livingEntity, float var2) {
      ...
      double var4 = livingEntity.y + (double)livingEntity.getEyeHeight() - 1.100000023841858D;
      double var6 = livingEntity.x - this.x;
      double var8 = var4 - var3.y;
      double var10 = livingEntity.z - this.z;
   ...
   public void setPumpkin(boolean pumpkin) {
      byte var2 = ((Byte)this.entityData.get(DATA_PUMPKIN_ID)).byteValue();
      if(pumpkin) {
         this.entityData.set(DATA_PUMPKIN_ID, Byte.valueOf((byte)(var2 | 16)));
      } else {
         this.entityData.set(DATA_PUMPKIN_ID, Byte.valueOf((byte)(var2 & -17)));
      }
