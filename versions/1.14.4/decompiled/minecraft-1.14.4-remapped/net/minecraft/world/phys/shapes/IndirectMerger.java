...
public final class IndirectMerger implements IndexMerger {
   ...
   protected IndirectMerger(DoubleList var1, DoubleList var2, boolean var3, boolean var4) {
      ...
      while(true) {
         ...
         boolean var14 = var12 && (!var13 || var1.getDouble(var5) < var2.getDouble(var6) + 1.0E-7D);
         double var15 = var14?var1.getDouble(var5++):var2.getDouble(var6++);
         if((var5 != 0 && var12 || var14 || var4) && (var6 != 0 && var13 || !var14 || var3)) {
   ...
   public boolean forMergedIndexes(IndexMerger.IndexConsumer indexMerger$IndexConsumer) {
      for(int var2 = 0; var2 < this.result.size() - 1; ++var2) {
         if(!indexMerger$IndexConsumer.merge(this.firstIndices.getInt(var2), this.secondIndices.getInt(var2), var2)) {
            return false;
         }
      }
