...
public abstract class CreativeModeTab {
   ...
   public static final CreativeModeTab TAB_HOTBAR = new CreativeModeTab(4, "hotbar") {
      ...
      public void fillItemList(NonNullList nonNullList) {
   ...
   public CreativeModeTab(int id, String langId) {
      this.id = id;
      this.langId = langId;
   ...
   public CreativeModeTab setBackgroundSuffix(String backgroundSuffix) {
      this.backgroundSuffix = backgroundSuffix;
      return this;
   }

   public CreativeModeTab setRecipeFolderName(String recipeFolderName) {
   ...
   public CreativeModeTab setEnchantmentCategories(EnchantmentCategory... enchantmentCategories) {
   ...
   public void fillItemList(NonNullList nonNullList) {
      for(Item var3 : Registry.ITEM) {
         var3.fillItemCategory(this, nonNullList);
      }
