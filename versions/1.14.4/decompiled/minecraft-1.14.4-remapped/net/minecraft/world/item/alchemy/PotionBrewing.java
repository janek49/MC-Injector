...
public class PotionBrewing {
   ...
   private static final Predicate ALLOWED_CONTAINER = (itemStack) -> {
      for(Ingredient var2 : ALLOWED_CONTAINERS) {
         if(var2.test(itemStack)) {
            return true;
         }
      }
   ...
   protected static boolean isContainerIngredient(ItemStack itemStack) {
      ...
      for(int var2 = CONTAINER_MIXES.size(); var1 < var2; ++var1) {
         if(((PotionBrewing.Mix)CONTAINER_MIXES.get(var1)).ingredient.test(itemStack)) {
            return true;
         }
      }
   ...
   protected static boolean isPotionIngredient(ItemStack itemStack) {
      ...
      for(int var2 = POTION_MIXES.size(); var1 < var2; ++var1) {
         if(((PotionBrewing.Mix)POTION_MIXES.get(var1)).ingredient.test(itemStack)) {
            return true;
         }
      }
   ...
   public static boolean isBrewablePotion(Potion potion) {
      ...
      for(int var2 = POTION_MIXES.size(); var1 < var2; ++var1) {
         if(((PotionBrewing.Mix)POTION_MIXES.get(var1)).to == potion) {
            return true;
         }
      }
   ...
   protected static boolean hasContainerMix(ItemStack var0, ItemStack var1) {
      ...
      for(int var4 = CONTAINER_MIXES.size(); var3 < var4; ++var3) {
         PotionBrewing.Mix<Item> var5 = (PotionBrewing.Mix)CONTAINER_MIXES.get(var3);
   ...
   protected static boolean hasPotionMix(ItemStack var0, ItemStack var1) {
      ...
      for(int var4 = POTION_MIXES.size(); var3 < var4; ++var3) {
         PotionBrewing.Mix<Potion> var5 = (PotionBrewing.Mix)POTION_MIXES.get(var3);
         if(var5.from == var2 && var5.ingredient.test(var1)) {
            return true;
         }
      }
   ...
   public static ItemStack mix(ItemStack var0, ItemStack var1) {
      if(!var1.isEmpty()) {
         ...
         for(int var5 = CONTAINER_MIXES.size(); var4 < var5; ++var4) {
            PotionBrewing.Mix<Item> var6 = (PotionBrewing.Mix)CONTAINER_MIXES.get(var4);
         ...
         for(int var5 = POTION_MIXES.size(); var4 < var5; ++var4) {
            PotionBrewing.Mix<Potion> var6 = (PotionBrewing.Mix)POTION_MIXES.get(var4);
   ...
   private static void addContainerRecipe(Item var0, Item var1, Item var2) {
      if(!(var0 instanceof PotionItem)) {
         ...
         CONTAINER_MIXES.add(new PotionBrewing.Mix(var0, Ingredient.of(new ItemLike[]{var1}), var2));
      }
   }
   ...
   private static void addContainer(Item item) {
      if(!(item instanceof PotionItem)) {
         ...
         ALLOWED_CONTAINERS.add(Ingredient.of(new ItemLike[]{item}));
      }
   }

   private static void addMix(Potion var0, Item item, Potion var2) {
      POTION_MIXES.add(new PotionBrewing.Mix(var0, Ingredient.of(new ItemLike[]{item}), var2));
   }
   ...
   static class Mix {
      ...
      public Mix(Object from, Ingredient ingredient, Object to) {
         this.from = from;
