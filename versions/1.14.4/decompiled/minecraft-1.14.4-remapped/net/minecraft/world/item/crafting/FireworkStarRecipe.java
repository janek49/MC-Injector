...
public class FireworkStarRecipe extends CustomRecipe {
   private static final Ingredient SHAPE_INGREDIENT = Ingredient.of(new ItemLike[]{Items.FIRE_CHARGE, Items.FEATHER, Items.GOLD_NUGGET, Items.SKELETON_SKULL, Items.WITHER_SKELETON_SKULL, Items.CREEPER_HEAD, Items.PLAYER_HEAD, Items.DRAGON_HEAD, Items.ZOMBIE_HEAD});
   private static final Ingredient TRAIL_INGREDIENT = Ingredient.of(new ItemLike[]{Items.DIAMOND});
   private static final Ingredient FLICKER_INGREDIENT = Ingredient.of(new ItemLike[]{Items.GLOWSTONE_DUST});
   private static final Map SHAPE_BY_ITEM = (Map)Util.make(Maps.newHashMap(), (hashMap) -> {
   ...
   public boolean matches(CraftingContainer craftingContainer, Level level) {
      ...
      for(int var8 = 0; var8 < craftingContainer.getContainerSize(); ++var8) {
         ItemStack var9 = craftingContainer.getItem(var8);
         if(!var9.isEmpty()) {
   ...
   public ItemStack assemble(CraftingContainer craftingContainer) {
      ...
      CompoundTag var3 = itemStack.getOrCreateTagElement("Explosion");
      ...
      for(int var6 = 0; var6 < craftingContainer.getContainerSize(); ++var6) {
         ...
         if(!var7.isEmpty()) {
            if(SHAPE_INGREDIENT.test(var7)) {
               ...
               var5.add(Integer.valueOf(((DyeItem)var7.getItem()).getDyeColor().getFireworkColor()));
            }
         }
      }
