...
public class EggItem extends Item {
   public EggItem(Item.Properties item$Properties) {
   ...
   public InteractionResultHolder use(Level level, Player player, InteractionHand interactionHand) {
      ...
      level.playSound((Player)null, player.x, player.y, player.z, SoundEvents.EGG_THROW, SoundSource.PLAYERS, 0.5F, 0.4F / (random.nextFloat() * 0.4F + 0.8F));
      if(!level.isClientSide) {
         ThrownEgg var5 = new ThrownEgg(level, player);
         var5.setItem(var4);
