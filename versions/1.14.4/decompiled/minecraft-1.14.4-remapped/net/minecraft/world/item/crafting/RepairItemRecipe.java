...
public class RepairItemRecipe extends CustomRecipe {
   ...
   public ItemStack assemble(CraftingContainer craftingContainer) {
      ...
      if(var2.size() == 2) {
         ItemStack var3 = (ItemStack)var2.get(0);
         ItemStack var4 = (ItemStack)var2.get(1);
         if(var3.getItem() == var4.getItem() && var3.getCount() == 1 && var4.getCount() == 1 && var3.getItem().canBeDepleted()) {
            Item var5 = var3.getItem();
            int var6 = var5.getMaxDamage() - var3.getDamageValue();
            int var7 = var5.getMaxDamage() - var4.getDamageValue();
            int var8 = var6 + var7 + var5.getMaxDamage() * 5 / 100;
            int var9 = var5.getMaxDamage() - var8;
            if(var9 < 0) {
               var9 = 0;
            }

            ItemStack var10 = new ItemStack(var3.getItem());
