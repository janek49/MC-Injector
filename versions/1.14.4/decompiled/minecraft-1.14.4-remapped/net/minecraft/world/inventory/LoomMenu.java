...
public class LoomMenu extends AbstractContainerMenu {
   ...
   public LoomMenu(int var1, Inventory inventory) {
      this(var1, inventory, ContainerLevelAccess.NULL);
   }

   public LoomMenu(int var1, Inventory inventory, final ContainerLevelAccess access) {
      ...
      this.resultSlot = this.addSlot(new Slot(this.outputContainer, 0, 143, 58) {
         ...
         public ItemStack onTake(Player player, ItemStack var2) {
            ...
            access.execute((level, blockPos) -> {
               level.playSound((Player)null, (BlockPos)blockPos, SoundEvents.UI_LOOM_TAKE_RESULT, SoundSource.BLOCKS, 1.0F, 1.0F);
            });
   ...
   public void removed(Player player) {
      ...
      this.access.execute((level, blockPos) -> {
         this.clearContainer(player, player.level, this.inputContainer);
      });
   }
