...
public class TheEndBiomeSource extends BiomeSource {
   ...
   public Biome getBiome(int var1, int var2) {
      ...
      if((long)var3 * (long)var3 + (long)var4 * (long)var4 <= 4096L) {
         ...
         return var5 > 40.0F?Biomes.END_HIGHLANDS:(var5 >= 0.0F?Biomes.END_MIDLANDS:(var5 < -20.0F?Biomes.SMALL_END_ISLANDS:Biomes.END_BARRENS));
      }
   }

   public Biome[] getBiomeBlock(int var1, int var2, int var3, int var4, boolean var5) {
      Biome[] biomes = new Biome[var3 * var4];
      Long2ObjectMap<Biome> var7 = new Long2ObjectOpenHashMap();
   ...
   public BlockPos findBiome(int var1, int var2, int var3, List list, Random random) {
      ...
      Biome[] vars12 = this.getBiomeBlock(var6, var7, var10, var11);
      BlockPos var13 = null;
      int var14 = 0;
