...
public class TaigaGrassFeature extends Feature {
   public TaigaGrassFeature(Function function) {
      super(function);
   }
   ...
   public boolean place(LevelAccessor levelAccessor, ChunkGenerator chunkGenerator, Random random, BlockPos blockPos, NoneFeatureConfiguration noneFeatureConfiguration) {
      ...
      for(int var9 = 0; var9 < 128; ++var9) {
         ...
         if(levelAccessor.isEmptyBlock(var10) && var6.canSurvive(levelAccessor, var10)) {
