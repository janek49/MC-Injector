...
public enum ShoreLayer implements CastleTransformer {
   ...
   private static boolean isJungleCompatible(int i) {
      return Registry.BIOME.byId(i) != null && ((Biome)Registry.BIOME.byId(i)).getBiomeCategory() == Biome.BiomeCategory.JUNGLE?true:i == JUNGLE_EDGE || i == JUNGLE || i == JUNGLE_HILLS || i == FOREST || i == TAIGA || Layers.isOcean(i);
   }
