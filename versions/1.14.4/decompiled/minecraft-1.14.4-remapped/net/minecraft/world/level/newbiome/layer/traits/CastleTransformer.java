...
public interface CastleTransformer extends AreaTransformer1, DimensionOffset1Transformer {
   ...
   default int applyPixel(BigContext bigContext, Area area, int var3, int var4) {
      return this.apply(bigContext, area.get(this.getParentX(var3 + 1), this.getParentY(var4 + 0)), area.get(this.getParentX(var3 + 2), this.getParentY(var4 + 1)), area.get(this.getParentX(var3 + 1), this.getParentY(var4 + 2)), area.get(this.getParentX(var3 + 0), this.getParentY(var4 + 1)), area.get(this.getParentX(var3 + 1), this.getParentY(var4 + 1)));
   }
}
