...
public enum BiomeEdgeLayer implements CastleTransformer {
   ...
   public int apply(Context context, int var2, int var3, int var4, int var5, int var6) {
      int[] vars7 = new int[1];
      if(!this.checkEdge(vars7, var2, var3, var4, var5, var6, MOUNTAINS, MOUNTAIN_EDGE) && !this.checkEdgeStrict(vars7, var2, var3, var4, var5, var6, WOODED_BADLANDS_PLATEAU, BADLANDS) && !this.checkEdgeStrict(vars7, var2, var3, var4, var5, var6, BADLANDS_PLATEAU, BADLANDS) && !this.checkEdgeStrict(vars7, var2, var3, var4, var5, var6, GIANT_TREE_TAIGA, TAIGA)) {
   ...
   private boolean checkEdge(int[] ints, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
   ...
   private boolean checkEdgeStrict(int[] ints, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      if(var6 != var7) {
         return false;
      } else {
