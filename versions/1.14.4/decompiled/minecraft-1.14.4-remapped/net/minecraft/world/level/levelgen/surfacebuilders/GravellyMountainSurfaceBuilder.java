...
public class GravellyMountainSurfaceBuilder extends SurfaceBuilder {
   public GravellyMountainSurfaceBuilder(Function function) {
      super(function);
   }
   ...
   public void apply(Random random, ChunkAccess chunkAccess, Biome biome, int var4, int var5, int var6, double var7, BlockState var9, BlockState var10, int var11, long var12, SurfaceBuilderBaseConfiguration surfaceBuilderBaseConfiguration) {
      if(var7 >= -1.0D && var7 <= 2.0D) {
         ...
         SurfaceBuilder.DEFAULT.apply(random, chunkAccess, biome, var4, var5, var6, var7, var9, var10, var11, var12, SurfaceBuilder.CONFIG_GRAVEL);
      }
