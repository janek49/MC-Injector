...
public enum NoteBlockInstrument implements StringRepresentable {
   ...
   private NoteBlockInstrument(String name, SoundEvent soundEvent) {
      this.name = name;
   ...
   public static NoteBlockInstrument byState(BlockState state) {
      ...
      if(var1 == Blocks.CLAY) {
         ...
         Material var2 = state.getMaterial();
         return var2 == Material.STONE?BASEDRUM:(var2 == Material.SAND?SNARE:(var2 == Material.GLASS?HAT:(var2 == Material.WOOD?BASS:HARP)));
      }
   }
}
