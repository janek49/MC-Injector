...
public final class Material {
   ...
   public static final Material TOP_SNOW = (new Material.Builder(MaterialColor.SNOW)).noCollider().notSolidBlocking().nonSolid().destroyOnPush().replaceable().notAlwaysDestroyable().build();
   ...
   public Material(MaterialColor color, boolean liquid, boolean solid, boolean blocksMotion, boolean solidBlocking, boolean alwaysDestroyable, boolean flammable, boolean replaceable, PushReaction pushReaction) {
      this.color = color;
      this.liquid = liquid;
      this.solid = solid;
