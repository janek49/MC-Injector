...
public class BoundingBox {
   ...
   public static BoundingBox orientBox(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, Direction direction) {
      switch(direction) {
      case NORTH:
