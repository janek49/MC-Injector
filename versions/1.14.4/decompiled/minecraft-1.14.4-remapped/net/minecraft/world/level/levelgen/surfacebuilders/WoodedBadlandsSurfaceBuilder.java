...
public class WoodedBadlandsSurfaceBuilder extends BadlandsSurfaceBuilder {
   ...
   public WoodedBadlandsSurfaceBuilder(Function function) {
      super(function);
   }
            ...
            if(var26.isAir()) {
               ...
               if(var21 == -1) {
                  ...
                  if(var25 >= var11 - 1) {
                     if(var25 > 86 + var19 * 2) {
                        if(var20) {
                           chunkAccess.setBlockState(var24, Blocks.COARSE_DIRT.defaultBlockState(), false);
                        } else {
                           chunkAccess.setBlockState(var24, Blocks.GRASS_BLOCK.defaultBlockState(), false);
                        }
