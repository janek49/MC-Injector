...
public class BlockStateProperties {
   ...
   public static final EnumProperty HORIZONTAL_AXIS = EnumProperty.create("axis", Direction.Axis.class, (Enum[])(new Direction.Axis[]{Direction.Axis.X, Direction.Axis.Z}));
   public static final EnumProperty AXIS = EnumProperty.create("axis", Direction.Axis.class);
   ...
   public static final DirectionProperty FACING = DirectionProperty.create("facing", new Direction[]{Direction.NORTH, Direction.EAST, Direction.SOUTH, Direction.WEST, Direction.UP, Direction.DOWN});
   ...
   public static final EnumProperty ATTACH_FACE = EnumProperty.create("face", AttachFace.class);
   public static final EnumProperty BELL_ATTACHMENT = EnumProperty.create("attachment", BellAttachType.class);
   public static final EnumProperty EAST_REDSTONE = EnumProperty.create("east", RedstoneSide.class);
   public static final EnumProperty NORTH_REDSTONE = EnumProperty.create("north", RedstoneSide.class);
   public static final EnumProperty SOUTH_REDSTONE = EnumProperty.create("south", RedstoneSide.class);
   public static final EnumProperty WEST_REDSTONE = EnumProperty.create("west", RedstoneSide.class);
   public static final EnumProperty DOUBLE_BLOCK_HALF = EnumProperty.create("half", DoubleBlockHalf.class);
   public static final EnumProperty HALF = EnumProperty.create("half", Half.class);
   public static final EnumProperty RAIL_SHAPE = EnumProperty.create("shape", RailShape.class);
   public static final EnumProperty RAIL_SHAPE_STRAIGHT = EnumProperty.create("shape", RailShape.class, (railShape) -> {
   ...
   public static final EnumProperty BED_PART = EnumProperty.create("part", BedPart.class);
   public static final EnumProperty CHEST_TYPE = EnumProperty.create("type", ChestType.class);
   public static final EnumProperty MODE_COMPARATOR = EnumProperty.create("mode", ComparatorMode.class);
   public static final EnumProperty DOOR_HINGE = EnumProperty.create("hinge", DoorHingeSide.class);
   public static final EnumProperty NOTEBLOCK_INSTRUMENT = EnumProperty.create("instrument", NoteBlockInstrument.class);
   public static final EnumProperty PISTON_TYPE = EnumProperty.create("type", PistonType.class);
   public static final EnumProperty SLAB_TYPE = EnumProperty.create("type", SlabType.class);
   public static final EnumProperty STAIRS_SHAPE = EnumProperty.create("shape", StairsShape.class);
   public static final EnumProperty STRUCTUREBLOCK_MODE = EnumProperty.create("mode", StructureMode.class);
   public static final EnumProperty BAMBOO_LEAVES = EnumProperty.create("leaves", BambooLeaves.class);
}
