...
public class VillagePieces {
   public static void addPieces(ChunkGenerator chunkGenerator, StructureManager structureManager, BlockPos blockPos, List list, WorldgenRandom worldgenRandom, VillageConfiguration villageConfiguration) {
      PlainVillagePools.bootstrap();
      SnowyVillagePools.bootstrap();
      SavannaVillagePools.bootstrap();
      DesertVillagePools.bootstrap();
      TaigaVillagePools.bootstrap();
      JigsawPlacement.addPieces(villageConfiguration.startPool, villageConfiguration.size, VillagePieces.VillagePiece::<init>, chunkGenerator, structureManager, blockPos, list, worldgenRandom);
   }

   public static class VillagePiece extends PoolElementStructurePiece {
      public VillagePiece(StructureManager structureManager, StructurePoolElement structurePoolElement, BlockPos blockPos, int var4, Rotation rotation, BoundingBox boundingBox) {
         super(StructurePieceType.VILLAGE, structureManager, structurePoolElement, blockPos, var4, rotation, boundingBox);
      }
