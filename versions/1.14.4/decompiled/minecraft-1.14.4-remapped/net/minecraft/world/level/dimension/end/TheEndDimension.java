...
public class TheEndDimension extends Dimension {
   ...
   public TheEndDimension(Level level, DimensionType dimensionType) {
      ...
      CompoundTag var3 = level.getLevelData().getDimensionData(DimensionType.THE_END);
      this.dragonFight = level instanceof ServerLevel?new EndDragonFight((ServerLevel)level, var3.getCompound("DragonFight")):null;
   }
   ...
   public BlockPos getSpawnPosInChunk(ChunkPos chunkPos, boolean var2) {
      ...
      BlockPos var4 = new BlockPos(chunkPos.getMinBlockX() + var3.nextInt(15), 0, chunkPos.getMaxBlockZ() + var3.nextInt(15));
