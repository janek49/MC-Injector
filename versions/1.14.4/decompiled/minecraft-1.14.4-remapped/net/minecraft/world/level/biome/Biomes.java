...
import net.minecraft.world.level.biome.BadlandsBiome;
...
import net.minecraft.world.level.biome.DeepFrozenOceanBiome;
import net.minecraft.world.level.biome.DeepLukeWarmOceanBiome;
import net.minecraft.world.level.biome.DeepOceanBiome;
import net.minecraft.world.level.biome.DeepWarmOceanBiome;
import net.minecraft.world.level.biome.DesertBiome;
import net.minecraft.world.level.biome.DesertHillsBiome;
import net.minecraft.world.level.biome.DesertLakesBiome;
import net.minecraft.world.level.biome.EndBarrensBiome;
import net.minecraft.world.level.biome.EndHighlandsBiome;
import net.minecraft.world.level.biome.EndMidlandsBiome;
import net.minecraft.world.level.biome.ErodedBadlandsBiome;
import net.minecraft.world.level.biome.ForestBiome;
import net.minecraft.world.level.biome.ForestFlowerBiome;
import net.minecraft.world.level.biome.FrozenOceanBiome;
import net.minecraft.world.level.biome.FrozenRiverBiome;
import net.minecraft.world.level.biome.GiantSpruceTaigaBiome;
import net.minecraft.world.level.biome.GiantSpruceTaigaHillsMutatedBiome;
import net.minecraft.world.level.biome.GiantTreeTaigaBiome;
import net.minecraft.world.level.biome.GiantTreeTaigaHillsBiome;
import net.minecraft.world.level.biome.GravellyMountainsBiome;
import net.minecraft.world.level.biome.IceSpikesBiome;
import net.minecraft.world.level.biome.JungleBiome;
import net.minecraft.world.level.biome.JungleEdgeBiome;
import net.minecraft.world.level.biome.JungleHillsBiome;
import net.minecraft.world.level.biome.LukeWarmOceanBiome;
import net.minecraft.world.level.biome.ModifiedBadlandsPlateauBiome;
import net.minecraft.world.level.biome.ModifiedGravellyMountainsBiome;
import net.minecraft.world.level.biome.ModifiedJungleBiome;
import net.minecraft.world.level.biome.ModifiedJungleEdgeBiome;
import net.minecraft.world.level.biome.ModifiedWoodedBadlandsPlateauBiome;
import net.minecraft.world.level.biome.MountainBiome;
...
import net.minecraft.world.level.biome.SavannaBiome;
import net.minecraft.world.level.biome.SavannaPlateauBiome;
import net.minecraft.world.level.biome.ShatteredSavannaBiome;
import net.minecraft.world.level.biome.ShatteredSavannaPlateauBiome;
import net.minecraft.world.level.biome.SmallEndIslandsBiome;
import net.minecraft.world.level.biome.SnowyBeachBiome;
import net.minecraft.world.level.biome.SnowyMountainsBiome;
import net.minecraft.world.level.biome.SnowyTaigaBiome;
...
import net.minecraft.world.level.biome.SwampHillsBiome;
import net.minecraft.world.level.biome.TaigaBiome;
import net.minecraft.world.level.biome.TaigaHillsBiome;
import net.minecraft.world.level.biome.TaigaMountainsBiome;
import net.minecraft.world.level.biome.TallBirchForestBiome;
import net.minecraft.world.level.biome.TallBirchHillsBiome;
...
public abstract class Biomes {
   ...
   private static Biome register(int var0, String string, Biome var2) {
      Registry.registerMapping(Registry.BIOME, var0, string, var2);
      if(var2.isMutated()) {
