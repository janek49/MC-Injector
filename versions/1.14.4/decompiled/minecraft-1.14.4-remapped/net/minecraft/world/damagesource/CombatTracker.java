...
public class CombatTracker {
   ...
   public void recordDamage(DamageSource damageSource, float var2, float var3) {
      this.recheckStatus();
      this.prepareForDamage();
      CombatEntry var4 = new CombatEntry(damageSource, this.mob.tickCount, var2, var3, this.nextLocation, this.mob.fallDistance);
   ...
   public LivingEntity getKiller() {
      ...
      for(CombatEntry var6 : this.entries) {
         ...
         if(var6.getSource().getEntity() instanceof LivingEntity && (livingEntity == null || var6.getDamage() > var3)) {
            var3 = var6.getDamage();
            livingEntity = (LivingEntity)var6.getSource().getEntity();
         }
      }
   ...
   private CombatEntry getMostSignificantFall() {
      ...
      for(int var5 = 0; var5 < this.entries.size(); ++var5) {
         ...
         if((var6.getSource() == DamageSource.FALL || var6.getSource() == DamageSource.OUT_OF_WORLD) && var6.getFallDistance() > 0.0F && (combatEntry == null || var6.getFallDistance() > var4)) {
            if(var5 > 0) {
               combatEntry = var7;
            } else {
               combatEntry = var6;
