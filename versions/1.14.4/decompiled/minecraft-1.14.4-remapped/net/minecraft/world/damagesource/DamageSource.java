...
public class DamageSource {
   ...
   public static DamageSource explosion(@Nullable Explosion explosion) {
      return explosion != null && explosion.getSourceMob() != null?(new EntityDamageSource("explosion.player", explosion.getSourceMob())).setScalesWithDifficulty().setExplosion():(new DamageSource("explosion")).setScalesWithDifficulty().setExplosion();
   }

   public static DamageSource explosion(@Nullable LivingEntity livingEntity) {
      return livingEntity != null?(new EntityDamageSource("explosion.player", livingEntity)).setScalesWithDifficulty().setExplosion():(new DamageSource("explosion")).setScalesWithDifficulty().setExplosion();
   }
   ...
   protected DamageSource(String msgId) {
      this.msgId = msgId;
   }
   ...
   public Component getLocalizedDeathMessage(LivingEntity livingEntity) {
      ...
      return livingEntity != null?new TranslatableComponent(var4, new Object[]{livingEntity.getDisplayName(), livingEntity.getDisplayName()}):new TranslatableComponent(var3, new Object[]{livingEntity.getDisplayName()});
   }
